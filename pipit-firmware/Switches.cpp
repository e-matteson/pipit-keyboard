...
//             // TODO how might this interact with the bouncy-switch grace
//             period? statuses.set(i, SwitchStatus::Pressed);
...
//   // Binary-encode the values of the switch_status array into an array of
//   bytes,
...
// // Fill up an array of chords, one for each pressed switch, instead of
// combining
...
//       // Switch is basically pressed! Other states don't matter in gaming
//       modes. chords[num_pressed].setSwitch(index); num_pressed++;
