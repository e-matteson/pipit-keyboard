#ifndef AUTO_CONFIG_22_H_
#define AUTO_CONFIG_22_H_
#include <Arduino.h>
#include "structs.h"
...
#define BLANK_KEY 0
#define NUM_HUFFMAN_CODES 66
#define MIN_HUFFMAN_CODE_BIT_LEN 4
