...
fn define_options() -> HashMap<String, OpDef> {
...
fn toml_to_vec(x: &Vec<toml::Value>) -> Vec<i64> {
...
fn set_options(map: &mut HashMap<String, OpDef>, parsed_options: &Value) {
...
// match t[key]{
//     Value::Int(ref subtable) => println!("Matched: {:#?}", key),
//     Value::
