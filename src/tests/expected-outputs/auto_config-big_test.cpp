...
const ChordData kmap0_Macro_len21_anagram0_chords[1] = {
 ChordData({0, 128, 192}), 
};

const uint8_t kmap0_Macro_len21_anagram0_seqs[3] = {
 36, 96, 29, 
};
...
const LookupKmapTypeLenAnagram* kmap0_Macro_lookups_array[10] = {
 &kmap0_Macro_len16_anagram0, &kmap0_Macro_len20_anagram0, &kmap0_Macro_len21_anagram0, &kmap0_Macro_len25_anagram0, 
 &kmap0_Macro_len26_anagram0, &kmap0_Macro_len27_anagram0, &kmap0_Macro_len32_anagram0, &kmap0_Macro_len33_anagram0, 
 &kmap0_Macro_len38_anagram0, &kmap0_Macro_len43_anagram0, 
};
...
const ChordData kmap0_Word_len7_anagram1_chords[3] = {
 ChordData({0, 0, 130}), ChordData({16, 0, 16}), ChordData({16, 0, 64}), 
};

const uint8_t kmap0_Word_len7_anagram1_seqs[3] = {
 160, 181, 5, 
};
...
const ChordData kmap0_Word_len8_anagram1_chords[4] = {
 ChordData({0, 4, 128}), ChordData({16, 8, 0}), ChordData({16, 64, 0}), ChordData({128, 0, 8}), 
};

const uint8_t kmap0_Word_len8_anagram1_seqs[4] = {
 79, 142, 193, 154, 
};
...
const ChordData kmap0_Word_len9_anagram0_chords[12] = {
...
const uint8_t kmap0_Word_len9_anagram0_seqs[14] = {
 27, 63, 62, 99, 
 211, 4, 112, 213, 
 42, 189, 147, 133, 
 132, 9, 
...
const ChordData kmap0_Word_len9_anagram4_chords[1] = {
 ChordData({34, 1, 0}), 
};

const uint8_t kmap0_Word_len9_anagram4_seqs[2] = {
 112, 0, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len9_anagram4 = {
  LengthAndAnagram(9, 4), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len9_anagram4_chords, // chords
  kmap0_Word_len9_anagram4_seqs, // sequences
};

const ChordData kmap0_Word_len10_anagram0_chords[5] = {
 ChordData({0, 0, 146}), ChordData({0, 1, 8}), ChordData({16, 0, 64}), ChordData({38, 0, 0}), 
 ChordData({128, 1, 0}), 
};

const uint8_t kmap0_Word_len10_anagram0_seqs[7] = {
 84, 118, 42, 118, 
 63, 217, 1, 
};
...
const ChordData kmap0_Word_len10_anagram1_chords[8] = {
...
const uint8_t kmap0_Word_len10_anagram1_seqs[10] = {
 91, 242, 51, 221, 
 217, 6, 29, 199, 
 73, 109, 
};
...
const ChordData kmap0_Word_len11_anagram0_chords[23] = {
...
const uint8_t kmap0_Word_len11_anagram0_seqs[32] = {
 7, 138, 101, 23, 
 128, 232, 195, 179, 
 158, 87, 140, 228, 
 35, 235, 154, 252, 
...
const ChordData kmap0_Word_len11_anagram2_chords[3] = {
 ChordData({0, 0, 146}), ChordData({16, 0, 65}), ChordData({16, 4, 1}), 
};

const uint8_t kmap0_Word_len11_anagram2_seqs[5] = {
 11, 178, 220, 249, 
 1, 
};
...
const ChordData kmap0_Word_len12_anagram0_chords[50] = {
...
const uint8_t kmap0_Word_len12_anagram0_seqs[75] = {
 114, 43, 139, 224, 
 130, 127, 175, 135, 
 175, 247, 187, 175, 
 242, 247, 68, 244, 
...
const ChordData kmap0_Word_len12_anagram1_chords[21] = {
...
const uint8_t kmap0_Word_len12_anagram1_seqs[32] = {
 143, 167, 127, 191, 
 135, 191, 79, 55, 
 114, 130, 35, 179, 
 157, 29, 125, 204, 
...
const ChordData kmap0_Word_len12_anagram2_chords[10] = {
...
const uint8_t kmap0_Word_len12_anagram2_seqs[15] = {
 247, 186, 127, 114, 
 79, 127, 55, 42, 
 115, 193, 42, 134, 
 208, 164, 169, 
...
const ChordData kmap0_Word_len13_anagram0_chords[71] = {
...
const uint8_t kmap0_Word_len13_anagram0_seqs[116] = {
 241, 47, 62, 198, 
 215, 223, 24, 159, 
 216, 139, 92, 40, 
 116, 132, 225, 53, 
...
const ChordData kmap0_Word_len13_anagram1_chords[30] = {
...
const uint8_t kmap0_Word_len13_anagram1_seqs[49] = {
 248, 113, 63, 138, 
 48, 246, 135, 31, 
 70, 226, 8, 219, 
 9, 237, 175, 61, 
...
const ChordData kmap0_Word_len13_anagram2_chords[5] = {
 ChordData({0, 12, 64}), ChordData({4, 4, 64}), ChordData({16, 8, 0}), ChordData({48, 9, 0}), 
 ChordData({132, 0, 1}), 
};

const uint8_t kmap0_Word_len13_anagram2_seqs[9] = {
 47, 81, 218, 71, 
 71, 232, 152, 237, 
 0, 
};
...
const ChordData kmap0_Word_len14_anagram0_chords[75] = {
...
const uint8_t kmap0_Word_len14_anagram0_seqs[132] = {
 183, 165, 148, 250, 
 90, 202, 151, 244, 
 101, 247, 215, 189, 
 118, 191, 5, 94, 
...
const ChordData kmap0_Word_len14_anagram1_chords[28] = {
...
const uint8_t kmap0_Word_len14_anagram1_seqs[49] = {
 82, 74, 248, 32, 
 15, 0, 115, 97, 
 226, 183, 246, 177, 
 177, 105, 183, 246, 
...
const ChordData kmap0_Word_len14_anagram2_chords[12] = {
...
const uint8_t kmap0_Word_len14_anagram2_seqs[21] = {
 184, 229, 62, 112, 
 182, 158, 201, 157, 
 3, 172, 26, 171, 
 116, 153, 45, 27, 
...
const ChordData kmap0_Word_len14_anagram3_chords[5] = {
 ChordData({32, 1, 8}), ChordData({32, 13, 0}), ChordData({34, 1, 0}), ChordData({128, 64, 10}), 
 ChordData({164, 0, 16}), 
};

const uint8_t kmap0_Word_len14_anagram3_seqs[9] = {
 80, 107, 124, 8, 
 7, 2, 169, 125, 
 46, 
};
...
const ChordData kmap0_Word_len14_anagram4_chords[3] = {
 ChordData({0, 4, 18}), ChordData({128, 64, 2}), ChordData({164, 0, 16}), 
};

const uint8_t kmap0_Word_len14_anagram4_seqs[6] = {
 251, 37, 38, 208, 
 111, 2, 
};
...
const ChordData kmap0_Word_len14_anagram7_chords[1] = {
 ChordData({0, 68, 18}), 
};

const uint8_t kmap0_Word_len14_anagram7_seqs[2] = {
 192, 47, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len14_anagram7 = {
  LengthAndAnagram(14, 7), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len14_anagram7_chords, // chords
  kmap0_Word_len14_anagram7_seqs, // sequences
};

const ChordData kmap0_Word_len15_anagram0_chords[77] = {
...
const uint8_t kmap0_Word_len15_anagram0_seqs[145] = {
 247, 32, 41, 99, 
 25, 169, 187, 24, 
 191, 124, 41, 134, 
 45, 67, 41, 5, 
...
const ChordData kmap0_Word_len15_anagram1_chords[33] = {
...
const uint8_t kmap0_Word_len15_anagram1_seqs[62] = {
 241, 186, 199, 98, 
 248, 178, 251, 208, 
 88, 139, 45, 172, 
 241, 206, 68, 224, 
...
const ChordData kmap0_Word_len15_anagram2_chords[22] = {
...
const uint8_t kmap0_Word_len15_anagram2_seqs[42] = {
 236, 75, 41, 206, 
 121, 85, 45, 162, 
 150, 19, 19, 237, 
 175, 207, 191, 251, 
...
const ChordData kmap0_Word_len15_anagram3_chords[1] = {
 ChordData({16, 0, 9}), 
};

const uint8_t kmap0_Word_len15_anagram3_seqs[2] = {
 103, 61, 
};
...
const ChordData kmap0_Word_len16_anagram0_chords[140] = {
...
const uint8_t kmap0_Word_len16_anagram0_seqs[280] = {
 120, 75, 221, 150, 
 29, 149, 248, 123, 
 248, 114, 130, 175, 
 247, 68, 248, 68, 
...
const ChordData kmap0_Word_len16_anagram1_chords[42] = {
...
const uint8_t kmap0_Word_len16_anagram1_seqs[84] = {
 114, 127, 114, 191, 
 248, 132, 242, 116, 
 163, 115, 55, 116, 
 55, 79, 242, 67, 
...
const ChordData kmap0_Word_len16_anagram2_chords[16] = {
...
const uint8_t kmap0_Word_len16_anagram2_seqs[32] = {
 247, 120, 66, 115, 
 209, 127, 225, 215, 
 55, 193, 97, 208, 
 237, 209, 173, 246, 
...
const ChordData kmap0_Word_len16_anagram3_chords[4] = {
 ChordData({16, 8, 0}), ChordData({16, 12, 1}), ChordData({20, 4, 16}), ChordData({128, 0, 8}), 
};

const uint8_t kmap0_Word_len16_anagram3_seqs[8] = {
 209, 209, 209, 247, 
 235, 111, 154, 169, 
};
...
const ChordData kmap0_Word_len17_anagram0_chords[173] = {
...
const uint8_t kmap0_Word_len17_anagram0_seqs[368] = {
 221, 131, 164, 88, 
 198, 223, 139, 47, 
 18, 127, 229, 216, 
 31, 178, 191, 99, 
...
const ChordData kmap0_Word_len17_anagram1_chords[65] = {
...
const uint8_t kmap0_Word_len17_anagram1_seqs[139] = {
 248, 20, 193, 63, 
 254, 34, 139, 163, 
 35, 55, 113, 226, 
 211, 177, 81, 97, 
...
const ChordData kmap0_Word_len17_anagram2_chords[18] = {
...
const uint8_t kmap0_Word_len17_anagram2_seqs[39] = {
 72, 31, 129, 7, 
 177, 145, 187, 253, 
 214, 70, 196, 32, 
 35, 96, 7, 224, 
...
const ChordData kmap0_Word_len17_anagram3_chords[3] = {
 ChordData({16, 68, 18}), ChordData({20, 0, 16}), ChordData({128, 64, 18}), 
};

const uint8_t kmap0_Word_len17_anagram3_seqs[7] = {
 128, 127, 219, 186, 
 97, 110, 0, 
};
...
const ChordData kmap0_Word_len18_anagram0_chords[147] = {
...
const uint8_t kmap0_Word_len18_anagram0_seqs[331] = {
 114, 95, 118, 143, 
 215, 189, 92, 247, 
 68, 29, 253, 105, 
 129, 199, 46, 82, 
...
const ChordData kmap0_Word_len18_anagram1_chords[40] = {
...
const uint8_t kmap0_Word_len18_anagram1_seqs[90] = {
 82, 42, 150, 191, 
 250, 68, 37, 62, 
 117, 5, 18, 177, 
 23, 6, 60, 17, 
...
const ChordData kmap0_Word_len18_anagram2_chords[15] = {
...
const uint8_t kmap0_Word_len18_anagram2_seqs[34] = {
 183, 95, 34, 125, 
 9, 0, 64, 193, 
 111, 38, 227, 145, 
 95, 220, 125, 52, 
...
const ChordData kmap0_Word_len19_anagram0_chords[140] = {
...
const uint8_t kmap0_Word_len19_anagram0_seqs[333] = {
 241, 181, 44, 63, 
 210, 189, 22, 245, 
 177, 184, 143, 197, 
 125, 45, 222, 75, 
...
const ChordData kmap0_Word_len19_anagram1_chords[57] = {
...
const uint8_t kmap0_Word_len19_anagram1_seqs[136] = {
 188, 124, 188, 199, 
 98, 247, 27, 195, 
 3, 122, 15, 154, 
 226, 136, 72, 113, 
...
const ChordData kmap0_Word_len19_anagram2_chords[14] = {
...
const uint8_t kmap0_Word_len19_anagram2_seqs[34] = {
 109, 191, 188, 125, 
 244, 175, 245, 145, 
 252, 123, 108, 109, 
 88, 183, 78, 172, 
...
const ChordData kmap0_Word_len19_anagram3_chords[7] = {
...
const uint8_t kmap0_Word_len19_anagram3_seqs[17] = {
 97, 31, 192, 63, 
 239, 189, 156, 233, 
 21, 13, 173, 94, 
 206, 219, 195, 164, 
...
const ChordData kmap0_Word_len19_anagram4_chords[2] = {
 ChordData({0, 68, 18}), ChordData({16, 4, 145}), 
};

const uint8_t kmap0_Word_len19_anagram4_seqs[5] = {
 192, 111, 120, 242, 
 30, 
};
...
const ChordData kmap0_Word_len20_anagram0_chords[155] = {
...
const uint8_t kmap0_Word_len20_anagram0_seqs[388] = {
 114, 191, 119, 251, 
 42, 248, 250, 132, 
 244, 34, 250, 242, 
 20, 127, 139, 236, 
...
const ChordData kmap0_Word_len20_anagram1_chords[47] = {
...
const uint8_t kmap0_Word_len20_anagram1_seqs[118] = {
 183, 143, 23, 95, 
 138, 177, 60, 38, 
 55, 68, 130, 67, 
 115, 115, 175, 183, 
...
const ChordData kmap0_Word_len20_anagram2_chords[17] = {
...
const uint8_t kmap0_Word_len20_anagram2_seqs[43] = {
 114, 79, 20, 135, 
 138, 235, 206, 219, 
 145, 125, 199, 124, 
 143, 143, 204, 254, 
...
const ChordData kmap0_Word_len20_anagram3_chords[2] = {
 ChordData({16, 36, 17}), ChordData({32, 1, 128}), 
};

const uint8_t kmap0_Word_len20_anagram3_seqs[5] = {
 204, 191, 7, 43, 
 117, 
};
...
const ChordData kmap0_Word_len21_anagram0_chords[171] = {
...
const uint8_t kmap0_Word_len21_anagram0_seqs[449] = {
 18, 127, 239, 233, 
 55, 74, 124, 34, 
 100, 191, 183, 175, 
 200, 110, 95, 24, 
...
const ChordData kmap0_Word_len21_anagram1_chords[44] = {
...
const uint8_t kmap0_Word_len21_anagram1_seqs[116] = {
 248, 135, 76, 232, 
 133, 197, 215, 121, 
 126, 248, 16, 166, 
 235, 190, 253, 94, 
...
const ChordData kmap0_Word_len21_anagram2_chords[12] = {
...
const uint8_t kmap0_Word_len21_anagram2_seqs[32] = {
 252, 199, 82, 218, 
 16, 109, 237, 75, 
 173, 209, 203, 121, 
 161, 91, 93, 113, 
...
const ChordData kmap0_Word_len21_anagram3_chords[4] = {
 ChordData({16, 0, 130}), ChordData({16, 4, 82}), ChordData({48, 8, 8}), ChordData({176, 1, 16}), 
};

const uint8_t kmap0_Word_len21_anagram3_seqs[11] = {
 6, 161, 201, 34, 
 95, 114, 214, 234, 
 77, 88, 13, 
};
...
const ChordData kmap0_Word_len21_anagram4_chords[2] = {
 ChordData({16, 4, 146}), ChordData({176, 1, 16}), 
};

const uint8_t kmap0_Word_len21_anagram4_seqs[6] = {
 107, 250, 114, 179, 
 66, 3, 
};
...
const ChordData kmap0_Word_len21_anagram5_chords[3] = {
 ChordData({16, 68, 18}), ChordData({128, 64, 2}), ChordData({128, 64, 18}), 
};

const uint8_t kmap0_Word_len21_anagram5_seqs[8] = {
 15, 252, 154, 15, 
 9, 96, 230, 6, 
};
...
const ChordData kmap0_Word_len22_anagram0_chords[191] = {
...
const uint8_t kmap0_Word_len22_anagram0_seqs[526] = {
 252, 242, 221, 239, 
 126, 201, 203, 239, 
 235, 203, 149, 184, 
 223, 93, 252, 67, 
...
const ChordData kmap0_Word_len22_anagram1_chords[44] = {
...
const uint8_t kmap0_Word_len22_anagram1_seqs[121] = {
 130, 191, 101, 247, 
 247, 132, 236, 55, 
 178, 7, 138, 84, 
 238, 32, 223, 248, 
...
const ChordData kmap0_Word_len22_anagram2_chords[12] = {
...
const uint8_t kmap0_Word_len22_anagram2_seqs[33] = {
 248, 187, 101, 155, 
 54, 135, 214, 243, 
 202, 173, 125, 184, 
 126, 241, 171, 26, 
...
const ChordData kmap0_Word_len22_anagram3_chords[4] = {
 ChordData({16, 4, 18}), ChordData({16, 4, 145}), ChordData({16, 4, 146}), ChordData({36, 1, 0}), 
};

const uint8_t kmap0_Word_len22_anagram3_seqs[11] = {
 248, 107, 239, 154, 
 254, 188, 166, 7, 
 181, 218, 117, 
};
...
const ChordData kmap0_Word_len22_anagram4_chords[2] = {
 ChordData({16, 4, 65}), ChordData({48, 9, 16}), 
};

const uint8_t kmap0_Word_len22_anagram4_seqs[6] = {
 150, 251, 115, 103, 
 206, 11, 
};
...
const ChordData kmap0_Word_len23_anagram0_chords[162] = {
...
const uint8_t kmap0_Word_len23_anagram0_seqs[466] = {
 183, 143, 69, 220, 
 215, 162, 220, 99, 
 17, 252, 177, 40, 
 244, 88, 148, 82, 
...
const ChordData kmap0_Word_len23_anagram1_chords[52] = {
...
const uint8_t kmap0_Word_len23_anagram1_seqs[150] = {
 124, 252, 59, 62, 
 254, 34, 238, 99, 
 177, 124, 100, 135, 
 175, 161, 4, 254, 
...
const ChordData kmap0_Word_len23_anagram2_chords[20] = {
...
const uint8_t kmap0_Word_len23_anagram2_seqs[58] = {
 251, 26, 202, 48, 
 191, 37, 48, 135, 
 76, 218, 126, 249, 
 187, 150, 195, 191, 
...
const ChordData kmap0_Word_len23_anagram4_chords[2] = {
 ChordData({128, 64, 18}), ChordData({160, 33, 1}), 
};

const uint8_t kmap0_Word_len23_anagram4_seqs[6] = {
 184, 9, 132, 203, 
 10, 25, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len23_anagram4 = {
  LengthAndAnagram(23, 4), // seq_bit_len_and_anagram
  2, // num_chords
  kmap0_Word_len23_anagram4_chords, // chords
  kmap0_Word_len23_anagram4_seqs, // sequences
};

const ChordData kmap0_Word_len23_anagram5_chords[1] = {
 ChordData({16, 4, 146}), 
};

const uint8_t kmap0_Word_len23_anagram5_seqs[3] = {
 124, 249, 100, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len23_anagram5 = {
  LengthAndAnagram(23, 5), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len23_anagram5_chords, // chords
  kmap0_Word_len23_anagram5_seqs, // sequences
};

const ChordData kmap0_Word_len23_anagram6_chords[1] = {
 ChordData({0, 68, 18}), 
};

const uint8_t kmap0_Word_len23_anagram6_seqs[3] = {
 15, 252, 6, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len23_anagram6 = {
  LengthAndAnagram(23, 6), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len23_anagram6_chords, // chords
  kmap0_Word_len23_anagram6_seqs, // sequences
};

const ChordData kmap0_Word_len24_anagram0_chords[164] = {
...
const uint8_t kmap0_Word_len24_anagram0_seqs[492] = {
 221, 43, 150, 199, 
 94, 139, 194, 126, 
 139, 60, 240, 119, 
 184, 35, 35, 114, 
...
const ChordData kmap0_Word_len24_anagram1_chords[36] = {
...
const uint8_t kmap0_Word_len24_anagram1_seqs[108] = {
 114, 223, 117, 72, 
 211, 117, 191, 55, 
 114, 114, 251, 163, 
 251, 56, 79, 192, 
...
const ChordData kmap0_Word_len24_anagram2_chords[8] = {
...
const uint8_t kmap0_Word_len24_anagram2_seqs[24] = {
 184, 115, 131, 97, 
 214, 120, 237, 233, 
 209, 109, 199, 114, 
 247, 11, 125, 152, 
...
const ChordData kmap0_Word_len24_anagram3_chords[2] = {
 ChordData({22, 8, 16}), ChordData({48, 8, 80}), 
};

const uint8_t kmap0_Word_len24_anagram3_seqs[6] = {
 142, 109, 214, 107, 
 169, 209, 
};
...
const ChordData kmap0_Word_len24_anagram4_chords[2] = {
 ChordData({16, 68, 18}), ChordData({16, 68, 146}), 
};

const uint8_t kmap0_Word_len24_anagram4_seqs[6] = {
 191, 248, 193, 184, 
 31, 200, 
};
...
const ChordData kmap0_Word_len25_anagram0_chords[179] = {
...
const uint8_t kmap0_Word_len25_anagram0_seqs[560] = {
 236, 247, 69, 248, 
 29, 44, 190, 78, 
 124, 226, 167, 192, 
 184, 31, 230, 41, 
...
const ChordData kmap0_Word_len25_anagram1_chords[38] = {
...
const uint8_t kmap0_Word_len25_anagram1_seqs[119] = {
 114, 251, 26, 164, 
 205, 206, 89, 196, 
 138, 238, 28, 159, 
 108, 16, 218, 97, 
...
const ChordData kmap0_Word_len25_anagram2_chords[8] = {
...
const uint8_t kmap0_Word_len25_anagram2_seqs[25] = {
 127, 247, 200, 12, 
 58, 235, 241, 79, 
 100, 229, 193, 95, 
 13, 140, 158, 247, 
...
const ChordData kmap0_Word_len25_anagram3_chords[4] = {
 ChordData({0, 12, 18}), ChordData({48, 1, 17}), ChordData({48, 5, 16}), ChordData({160, 65, 0}), 
};

const uint8_t kmap0_Word_len25_anagram3_seqs[13] = {
 124, 252, 45, 215, 
 93, 61, 195, 223, 
 135, 230, 67, 86, 
 8, 
...
const ChordData kmap0_Word_len26_anagram0_chords[154] = {
...
const uint8_t kmap0_Word_len26_anagram0_seqs[501] = {
 242, 244, 91, 226, 
 107, 129, 119, 236, 
 233, 35, 31, 23, 
 12, 0, 123, 44, 
...
const ChordData kmap0_Word_len26_anagram2_chords[16] = {
...
const uint8_t kmap0_Word_len26_anagram2_seqs[52] = {
 188, 252, 232, 53, 
 250, 130, 143, 204, 
 187, 101, 247, 199, 
 188, 192, 250, 144, 
...
const ChordData kmap0_Word_len26_anagram3_chords[2] = {
 ChordData({36, 0, 18}), ChordData({48, 5, 136}), 
};

const uint8_t kmap0_Word_len26_anagram3_seqs[7] = {
 173, 182, 86, 118, 
 244, 10, 13, 
};
...
const ChordData kmap0_Word_len27_anagram0_chords[153] = {
...
const uint8_t kmap0_Word_len27_anagram0_seqs[517] = {
 241, 247, 202, 253, 
 187, 199, 34, 63, 
 66, 31, 121, 100, 
 59, 210, 141, 142, 
...
const ChordData kmap0_Word_len27_anagram1_chords[25] = {
...
const uint8_t kmap0_Word_len27_anagram1_seqs[85] = {
 29, 125, 177, 228, 
 229, 247, 25, 143, 
 108, 244, 5, 95, 
 213, 139, 214, 219, 
...
const ChordData kmap0_Word_len27_anagram2_chords[7] = {
...
const uint8_t kmap0_Word_len27_anagram2_seqs[24] = {
 252, 149, 228, 93, 
 199, 223, 98, 48, 
 210, 175, 173, 244, 
 11, 221, 215, 245, 
...
const ChordData kmap0_Word_len27_anagram3_chords[2] = {
 ChordData({16, 68, 146}), ChordData({52, 0, 80}), 
};

const uint8_t kmap0_Word_len27_anagram3_seqs[7] = {
 244, 64, 233, 149, 
 218, 188, 61, 
};
...
const ChordData kmap0_Word_len28_anagram0_chords[134] = {
...
const uint8_t kmap0_Word_len28_anagram0_seqs[469] = {
 199, 94, 139, 242, 
 4, 124, 41, 177, 
 148, 66, 52, 42, 
 247, 122, 183, 175, 
...
const ChordData kmap0_Word_len28_anagram1_chords[28] = {
...
const uint8_t kmap0_Word_len28_anagram1_seqs[98] = {
 72, 47, 50, 248, 
 93, 247, 179, 188, 
 0, 35, 194, 159, 
 65, 47, 248, 130, 
...
const ChordData kmap0_Word_len28_anagram2_chords[11] = {
...
const uint8_t kmap0_Word_len28_anagram2_seqs[39] = {
 188, 190, 98, 201, 
 207, 61, 149, 205, 
 139, 110, 215, 214, 
 237, 215, 237, 247, 
...
const ChordData kmap0_Word_len28_anagram3_chords[5] = {
 ChordData({0, 4, 19}), ChordData({48, 0, 147}), ChordData({48, 8, 24}), ChordData({48, 13, 64}), 
 ChordData({128, 4, 27}), 
};

const uint8_t kmap0_Word_len28_anagram3_seqs[18] = {
 127, 183, 143, 135, 
 84, 239, 188, 107, 
 206, 90, 205, 115, 
 134, 47, 248, 123, 
...
const ChordData kmap0_Word_len29_anagram0_chords[149] = {
...
const uint8_t kmap0_Word_len29_anagram0_seqs[541] = {
 82, 234, 61, 72, 
 112, 255, 144, 45, 
 43, 143, 69, 62, 
 148, 244, 202, 71, 
...
const ChordData kmap0_Word_len29_anagram1_chords[27] = {
...
const uint8_t kmap0_Word_len29_anagram1_seqs[98] = {
 191, 199, 118, 112, 
 63, 12, 62, 241, 
 166, 31, 125, 126, 
 100, 223, 4, 236, 
...
const ChordData kmap0_Word_len29_anagram2_chords[5] = {
 ChordData({16, 4, 153}), ChordData({16, 4, 155}), ChordData({36, 8, 0}), ChordData({48, 1, 16}), 
 ChordData({52, 12, 16}), 
};

const uint8_t kmap0_Word_len29_anagram2_seqs[19] = {
 60, 248, 171, 143, 
 254, 172, 88, 246, 
 181, 96, 193, 117, 
 87, 161, 253, 125, 
...
const ChordData kmap0_Word_len29_anagram3_chords[3] = {
 ChordData({18, 0, 131}), ChordData({18, 64, 19}), ChordData({160, 33, 1}), 
};

const uint8_t kmap0_Word_len29_anagram3_seqs[11] = {
 103, 208, 13, 249, 
 128, 185, 243, 118, 
 89, 33, 59, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len29_anagram3 = {
  LengthAndAnagram(29, 3), // seq_bit_len_and_anagram
  3, // num_chords
  kmap0_Word_len29_anagram3_chords, // chords
  kmap0_Word_len29_anagram3_seqs, // sequences
};

const ChordData kmap0_Word_len30_anagram0_chords[117] = {
...
const uint8_t kmap0_Word_len30_anagram0_seqs[439] = {
 188, 240, 199, 43, 
 110, 41, 247, 196, 
 199, 21, 48, 60, 
 110, 73, 131, 221, 
...
const ChordData kmap0_Word_len30_anagram1_chords[26] = {
...
const uint8_t kmap0_Word_len30_anagram1_seqs[98] = {
 188, 240, 194, 19, 
 210, 239, 92, 105, 
 189, 125, 69, 27, 
 116, 251, 120, 124, 
...
const ChordData kmap0_Word_len30_anagram2_chords[8] = {
...
const uint8_t kmap0_Word_len30_anagram2_seqs[30] = {
 220, 235, 16, 253, 
 25, 116, 117, 13, 
 159, 200, 91, 114, 
 163, 247, 208, 125, 
...
const ChordData kmap0_Word_len31_anagram0_chords[106] = {
...
const uint8_t kmap0_Word_len31_anagram0_seqs[411] = {
 124, 224, 149, 23, 
 94, 94, 195, 62, 
 178, 223, 185, 178, 
 163, 71, 156, 192, 
...
const ChordData kmap0_Word_len31_anagram1_chords[22] = {
...
const uint8_t kmap0_Word_len31_anagram1_seqs[86] = {
 188, 254, 177, 87, 
 62, 240, 202, 63, 
 63, 188, 240, 237, 
 202, 54, 248, 212, 
...
const ChordData kmap0_Word_len31_anagram2_chords[5] = {
 ChordData({0, 68, 10}), ChordData({16, 0, 146}), ChordData({32, 0, 146}), ChordData({48, 5, 128}), 
 ChordData({54, 8, 192}), 
};

const uint8_t kmap0_Word_len31_anagram2_seqs[20] = {
 60, 190, 126, 120, 
 30, 220, 187, 37, 
 85, 80, 221, 146, 
 42, 132, 15, 45, 
...
const ChordData kmap0_Word_len32_anagram0_chords[111] = {
...
const uint8_t kmap0_Word_len32_anagram0_seqs[444] = {
 188, 242, 37, 143, 
 221, 235, 189, 148, 
 93, 97, 40, 160, 
 124, 241, 143, 149, 
...
const ChordData kmap0_Word_len32_anagram1_chords[16] = {
...
const uint8_t kmap0_Word_len32_anagram1_seqs[64] = {
 232, 232, 243, 150, 
 177, 148, 243, 150, 
 163, 55, 241, 207, 
 143, 56, 193, 122, 
...
const ChordData kmap0_Word_len33_anagram0_chords[87] = {
...
const uint8_t kmap0_Word_len33_anagram0_seqs[359] = {
 124, 199, 7, 254, 
 187, 223, 15, 95, 
 198, 31, 189, 31, 
 197, 157, 56, 250, 
...
const ChordData kmap0_Word_len33_anagram1_chords[15] = {
...
const uint8_t kmap0_Word_len33_anagram1_seqs[62] = {
 124, 228, 27, 207, 
 70, 187, 209, 57, 
 71, 35, 123, 29, 
 68, 230, 56, 248, 
...
const ChordData kmap0_Word_len34_anagram0_chords[74] = {
...
const uint8_t kmap0_Word_len34_anagram0_seqs[315] = {
 114, 175, 225, 55, 
 188, 62, 149, 50, 
 194, 70, 218, 235, 
 224, 186, 243, 90, 
...
const ChordData kmap0_Word_len34_anagram1_chords[12] = {
...
const uint8_t kmap0_Word_len34_anagram1_seqs[51] = {
 248, 247, 84, 202, 
 253, 222, 116, 143, 
 103, 61, 239, 253, 
 232, 186, 173, 197, 
...
const ChordData kmap0_Word_len34_anagram2_chords[2] = {
 ChordData({38, 1, 0}), ChordData({48, 5, 136}), 
};

const uint8_t kmap0_Word_len34_anagram2_seqs[9] = {
 124, 199, 247, 252, 
 208, 43, 172, 15, 
 13, 
};
...
const ChordData kmap0_Word_len35_anagram0_chords[67] = {
...
const uint8_t kmap0_Word_len35_anagram0_seqs[294] = {
 129, 127, 30, 121, 
 236, 62, 14, 205, 
 47, 126, 123, 156, 
 43, 111, 95, 133, 
...
const ChordData kmap0_Word_len36_anagram0_chords[54] = {
...
const uint8_t kmap0_Word_len36_anagram0_seqs[243] = {
 192, 239, 190, 94, 
 249, 64, 17, 248, 
 13, 72, 47, 50, 
 93, 201, 239, 32, 
...
const ChordData kmap0_Word_len36_anagram1_chords[9] = {
...
const uint8_t kmap0_Word_len36_anagram1_seqs[41] = {
 114, 127, 35, 55, 
 216, 61, 14, 205, 
 149, 6, 161, 137, 
 172, 39, 198, 245, 
...
const ChordData kmap0_Word_len37_anagram0_chords[66] = {
...
const uint8_t kmap0_Word_len37_anagram0_seqs[306] = {
 124, 199, 63, 95, 
 72, 110, 98, 165, 
 63, 227, 206, 13, 
 142, 68, 100, 59, 
...
const ChordData kmap0_Word_len37_anagram1_chords[5] = {
 ChordData({18, 12, 138}), ChordData({22, 0, 154}), ChordData({22, 4, 138}), ChordData({52, 4, 208}), 
 ChordData({180, 64, 18}), 
};

const uint8_t kmap0_Word_len37_anagram1_seqs[24] = {
 124, 52, 104, 240, 
 181, 237, 40, 78, 
 35, 127, 107, 52, 
 175, 104, 113, 251, 
...
const ChordData kmap0_Word_len37_anagram3_chords[1] = {
 ChordData({48, 5, 17}), 
};

const uint8_t kmap0_Word_len37_anagram3_seqs[5] = {
 15, 225, 26, 254, 
 25, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len37_anagram3 = {
  LengthAndAnagram(37, 3), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len37_anagram3_chords, // chords
  kmap0_Word_len37_anagram3_seqs, // sequences
};

const ChordData kmap0_Word_len38_anagram0_chords[38] = {
...
const uint8_t kmap0_Word_len38_anagram0_seqs[181] = {
 221, 235, 189, 220, 
 96, 124, 100, 163, 
 35, 135, 108, 71, 
 46, 190, 180, 29, 
...
const ChordData kmap0_Word_len38_anagram1_chords[5] = {
 ChordData({18, 32, 91}), ChordData({22, 0, 89}), ChordData({48, 5, 26}), ChordData({54, 0, 147}), 
 ChordData({178, 8, 137}), 
};

const uint8_t kmap0_Word_len38_anagram1_seqs[24] = {
 82, 234, 49, 203, 
 136, 245, 188, 109, 
 71, 220, 237, 195, 
 125, 69, 163, 201, 
...
const ChordData kmap0_Word_len39_anagram0_chords[35] = {
...
const uint8_t kmap0_Word_len39_anagram0_seqs[171] = {
 50, 113, 232, 151, 
 202, 48, 93, 231, 
 181, 158, 148, 177, 
 253, 177, 242, 187, 
...
const ChordData kmap0_Word_len39_anagram1_chords[3] = {
 ChordData({16, 68, 83}), ChordData({50, 1, 25}), ChordData({146, 0, 75}), 
};

const uint8_t kmap0_Word_len39_anagram1_seqs[15] = {
 165, 229, 188, 225, 
 203, 174, 174, 206, 
 213, 53, 166, 202, 
 200, 89, 15, 
...
const ChordData kmap0_Word_len40_anagram0_chords[29] = {
...
const uint8_t kmap0_Word_len40_anagram0_seqs[145] = {
 188, 242, 207, 11, 
 255, 109, 39, 254, 
 14, 149, 107, 73, 
 170, 55, 169, 193, 
...
const ChordData kmap0_Word_len41_anagram0_chords[37] = {
...
const uint8_t kmap0_Word_len41_anagram0_seqs[190] = {
 173, 220, 143, 19, 
 158, 254, 238, 145, 
 69, 235, 9, 142, 
 245, 166, 27, 12, 
...
const ChordData kmap0_Word_len42_anagram0_chords[32] = {
...
const uint8_t kmap0_Word_len42_anagram0_seqs[168] = {
 191, 55, 221, 224, 
 60, 133, 233, 58, 
 175, 21, 29, 166, 
 235, 6, 43, 93, 
...
const ChordData kmap0_Word_len42_anagram1_chords[1] = {
 ChordData({134, 0, 25}), 
};

const uint8_t kmap0_Word_len42_anagram1_seqs[6] = {
 109, 179, 229, 222, 
 164, 2, 
};
...
const ChordData kmap0_Word_len43_anagram0_chords[25] = {
...
const uint8_t kmap0_Word_len43_anagram0_seqs[135] = {
 124, 227, 3, 31, 
 121, 9, 145, 111, 
 124, 199, 99, 252, 
 209, 179, 190, 162, 
...
const ChordData kmap0_Word_len45_anagram0_chords[15] = {
...
const uint8_t kmap0_Word_len45_anagram0_seqs[85] = {
 183, 15, 110, 188, 
 220, 50, 122, 145, 
 189, 134, 17, 183, 
 223, 27, 156, 246, 
...
const ChordData kmap0_Word_len46_anagram1_chords[1] = {
 ChordData({32, 8, 18}), 
};

const uint8_t kmap0_Word_len46_anagram1_seqs[6] = {
 124, 201, 71, 62, 
 242, 28, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len46_anagram1 = {
  LengthAndAnagram(46, 1), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len46_anagram1_chords, // chords
  kmap0_Word_len46_anagram1_seqs, // sequences
};

const ChordData kmap0_Word_len47_anagram0_chords[13] = {
...
const uint8_t kmap0_Word_len47_anagram0_seqs[77] = {
 109, 77, 19, 71, 
 127, 75, 25, 168, 
 211, 13, 190, 158, 
 212, 94, 238, 245, 
...
const ChordData kmap0_Word_len48_anagram0_chords[4] = {
 ChordData({48, 13, 27}), ChordData({130, 5, 154}), ChordData({164, 8, 16}), ChordData({182, 72, 26}), 
};

const uint8_t kmap0_Word_len48_anagram0_seqs[24] = {
 241, 181, 118, 143, 
 87, 215, 60, 62, 
 77, 151, 171, 243, 
 124, 219, 228, 38, 
...
const ChordData kmap0_Word_len49_anagram0_chords[14] = {
...
const uint8_t kmap0_Word_len49_anagram0_seqs[86] = {
 143, 69, 77, 128, 
 28, 160, 249, 229, 
 145, 47, 76, 188, 
 132, 17, 220, 137, 
...
const ChordData kmap0_Word_len50_anagram0_chords[5] = {
 ChordData({2, 4, 66}), ChordData({4, 4, 66}), ChordData({32, 68, 130}), ChordData({162, 68, 203}), 
 ChordData({178, 12, 201}), 
};

const uint8_t kmap0_Word_len50_anagram0_seqs[32] = {
 252, 243, 194, 35, 
 63, 252, 240, 141, 
 71, 190, 48, 241, 
 242, 88, 168, 142, 
...
const ChordData kmap0_Word_len51_anagram0_chords[3] = {
 ChordData({6, 8, 1}), ChordData({38, 8, 211}), ChordData({164, 0, 17}), 
};

const uint8_t kmap0_Word_len51_anagram0_seqs[20] = {
 19, 91, 37, 25, 
 110, 174, 156, 216, 
 42, 201, 112, 115, 
 101, 219, 236, 191, 
...
const ChordData kmap0_Word_len55_anagram0_chords[1] = {
 ChordData({2, 13, 0}), 
};

const uint8_t kmap0_Word_len55_anagram0_seqs[7] = {
 252, 243, 29, 255, 
 252, 240, 69, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len55_anagram0 = {
  LengthAndAnagram(55, 0), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len55_anagram0_chords, // chords
  kmap0_Word_len55_anagram0_seqs, // sequences
};

const ChordData kmap0_Word_len57_anagram0_chords[3] = {
 ChordData({22, 76, 219}), ChordData({32, 40, 66}), ChordData({34, 5, 219}), 
};

const uint8_t kmap0_Word_len57_anagram0_seqs[22] = {
 188, 0, 115, 5, 
 189, 244, 26, 120, 
 142, 199, 194, 195, 
 115, 188, 200, 64, 
...
const ChordData kmap0_Word_len71_anagram0_chords[1] = {
 ChordData({164, 36, 9}), 
};

const uint8_t kmap0_Word_len71_anagram0_seqs[9] = {
 124, 207, 43, 159, 
 5, 164, 48, 22, 
 70, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len71_anagram0 = {
  LengthAndAnagram(71, 0), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len71_anagram0_chords, // chords
  kmap0_Word_len71_anagram0_seqs, // sequences
};

const ChordData kmap0_Word_len79_anagram0_chords[1] = {
 ChordData({34, 65, 82}), 
};

const uint8_t kmap0_Word_len79_anagram0_seqs[10] = {
 60, 192, 151, 188, 
 240, 195, 3, 124, 
 201, 67, 
};

const LookupKmapTypeLenAnagram kmap0_Word_len79_anagram0 = {
  LengthAndAnagram(79, 0), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len79_anagram0_chords, // chords
  kmap0_Word_len79_anagram0_seqs, // sequences
};

const ChordData kmap0_Word_len102_anagram0_chords[1] = {
 ChordData({16, 1, 144}), 
};

const uint8_t kmap0_Word_len102_anagram0_seqs[13] = {
 235, 142, 140, 55, 
 169, 5, 152, 216, 
 42, 201, 112, 115, 
 37, 
...
const LookupKmapTypeLenAnagram kmap0_Word_len102_anagram0 = {
  LengthAndAnagram(102, 0), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len102_anagram0_chords, // chords
  kmap0_Word_len102_anagram0_seqs, // sequences
};

const ChordData kmap0_Word_len105_anagram0_chords[1] = {
 ChordData({2, 5, 0}), 
};

const uint8_t kmap0_Word_len105_anagram0_seqs[14] = {
 47, 5, 232, 126, 
 11, 240, 82, 0, 
 126, 10, 80, 212, 
 4, 0, 
...
const LookupKmapTypeLenAnagram kmap0_Word_len105_anagram0 = {
  LengthAndAnagram(105, 0), // seq_bit_len_and_anagram
  1, // num_chords
  kmap0_Word_len105_anagram0_chords, // chords
  kmap0_Word_len105_anagram0_seqs, // sequences
};
...
const LookupKmapTypeLenAnagram* kmap0_Word_lookups_array[174] = {
 ...
 &kmap0_Word_len9_anagram2, &kmap0_Word_len9_anagram4, &kmap0_Word_len10_anagram0, &kmap0_Word_len10_anagram1, 
 &kmap0_Word_len10_anagram2, &kmap0_Word_len10_anagram3, &kmap0_Word_len11_anagram0, &kmap0_Word_len11_anagram1, 
 ...
 &kmap0_Word_len14_anagram7, &kmap0_Word_len15_anagram0, &kmap0_Word_len15_anagram1, &kmap0_Word_len15_anagram2, 
 &kmap0_Word_len15_anagram3, &kmap0_Word_len15_anagram5, &kmap0_Word_len16_anagram0, &kmap0_Word_len16_anagram1, 
 &kmap0_Word_len16_anagram2, &kmap0_Word_len16_anagram3, &kmap0_Word_len17_anagram0, &kmap0_Word_len17_anagram1, 
 &kmap0_Word_len17_anagram2, &kmap0_Word_len17_anagram3, &kmap0_Word_len17_anagram5, &kmap0_Word_len18_anagram0, 
 &kmap0_Word_len18_anagram1, &kmap0_Word_len18_anagram2, &kmap0_Word_len18_anagram3, &kmap0_Word_len19_anagram0, 
 &kmap0_Word_len19_anagram1, &kmap0_Word_len19_anagram2, &kmap0_Word_len19_anagram3, &kmap0_Word_len19_anagram4, 
 &kmap0_Word_len20_anagram0, &kmap0_Word_len20_anagram1, &kmap0_Word_len20_anagram2, &kmap0_Word_len20_anagram3, 
 &kmap0_Word_len20_anagram6, &kmap0_Word_len21_anagram0, &kmap0_Word_len21_anagram1, &kmap0_Word_len21_anagram2, 
 &kmap0_Word_len21_anagram3, &kmap0_Word_len21_anagram4, &kmap0_Word_len21_anagram5, &kmap0_Word_len22_anagram0, 
 &kmap0_Word_len22_anagram1, &kmap0_Word_len22_anagram2, &kmap0_Word_len22_anagram3, &kmap0_Word_len22_anagram4, 
 &kmap0_Word_len22_anagram6, &kmap0_Word_len23_anagram0, &kmap0_Word_len23_anagram1, &kmap0_Word_len23_anagram2, 
 &kmap0_Word_len23_anagram3, &kmap0_Word_len23_anagram4, &kmap0_Word_len23_anagram5, &kmap0_Word_len23_anagram6, 
 &kmap0_Word_len24_anagram0, &kmap0_Word_len24_anagram1, &kmap0_Word_len24_anagram2, &kmap0_Word_len24_anagram3, 
 &kmap0_Word_len24_anagram4, &kmap0_Word_len24_anagram5, &kmap0_Word_len25_anagram0, &kmap0_Word_len25_anagram1, 
 &kmap0_Word_len25_anagram2, &kmap0_Word_len25_anagram3, &kmap0_Word_len25_anagram4, &kmap0_Word_len26_anagram0, 
 &kmap0_Word_len26_anagram1, &kmap0_Word_len26_anagram2, &kmap0_Word_len26_anagram3, &kmap0_Word_len26_anagram4, 
 &kmap0_Word_len27_anagram0, &kmap0_Word_len27_anagram1, &kmap0_Word_len27_anagram2, &kmap0_Word_len27_anagram3, 
 &kmap0_Word_len27_anagram7, &kmap0_Word_len28_anagram0, &kmap0_Word_len28_anagram1, &kmap0_Word_len28_anagram2, 
 &kmap0_Word_len28_anagram3, &kmap0_Word_len28_anagram4, &kmap0_Word_len29_anagram0, &kmap0_Word_len29_anagram1, 
 &kmap0_Word_len29_anagram2, &kmap0_Word_len29_anagram3, &kmap0_Word_len30_anagram0, &kmap0_Word_len30_anagram1, 
 &kmap0_Word_len30_anagram2, &kmap0_Word_len31_anagram0, &kmap0_Word_len31_anagram1, &kmap0_Word_len31_anagram2, 
 &kmap0_Word_len31_anagram3, &kmap0_Word_len32_anagram0, &kmap0_Word_len32_anagram1, &kmap0_Word_len32_anagram2, 
 &kmap0_Word_len33_anagram0, &kmap0_Word_len33_anagram1, &kmap0_Word_len33_anagram2, &kmap0_Word_len33_anagram3, 
 &kmap0_Word_len34_anagram0, &kmap0_Word_len34_anagram1, &kmap0_Word_len34_anagram2, &kmap0_Word_len34_anagram4, 
 &kmap0_Word_len35_anagram0, &kmap0_Word_len35_anagram1, &kmap0_Word_len35_anagram2, &kmap0_Word_len36_anagram0, 
 &kmap0_Word_len36_anagram1, &kmap0_Word_len37_anagram0, &kmap0_Word_len37_anagram1, &kmap0_Word_len37_anagram2, 
 &kmap0_Word_len37_anagram3, &kmap0_Word_len38_anagram0, &kmap0_Word_len38_anagram1, &kmap0_Word_len38_anagram2, 
 &kmap0_Word_len39_anagram0, &kmap0_Word_len39_anagram1, &kmap0_Word_len40_anagram0, &kmap0_Word_len40_anagram1, 
 &kmap0_Word_len40_anagram2, &kmap0_Word_len41_anagram0, &kmap0_Word_len41_anagram1, &kmap0_Word_len42_anagram0, 
 &kmap0_Word_len42_anagram1, &kmap0_Word_len43_anagram0, &kmap0_Word_len44_anagram0, &kmap0_Word_len44_anagram1, 
 &kmap0_Word_len45_anagram0, &kmap0_Word_len45_anagram3, &kmap0_Word_len46_anagram0, &kmap0_Word_len46_anagram1, 
 &kmap0_Word_len47_anagram0, &kmap0_Word_len48_anagram0, &kmap0_Word_len49_anagram0, &kmap0_Word_len49_anagram1, 
 &kmap0_Word_len50_anagram0, &kmap0_Word_len51_anagram0, &kmap0_Word_len51_anagram1, &kmap0_Word_len52_anagram0, 
 &kmap0_Word_len52_anagram2, &kmap0_Word_len53_anagram0, &kmap0_Word_len55_anagram0, &kmap0_Word_len57_anagram0, 
 &kmap0_Word_len58_anagram0, &kmap0_Word_len60_anagram0, &kmap0_Word_len71_anagram0, &kmap0_Word_len79_anagram0, 
 &kmap0_Word_len102_anagram0, &kmap0_Word_len105_anagram0, 
};
