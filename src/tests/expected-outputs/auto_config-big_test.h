...
c_array_t<HuffmanChar, 105> const huffman_lookup = {HuffmanChar {HuffmanBits {{6}},
  3,
  ...
  false},
  HuffmanChar {HuffmanBits {{61}},
  6,
  static_cast<uint8_t>(KEY_B),
  false}, HuffmanChar {HuffmanBits {{29}},
  6,
  static_cast<uint8_t>(KEY_F),
  false}, HuffmanChar {HuffmanBits {{28}},
  6,
  ...
  false},
  HuffmanChar {HuffmanBits {{37}},
  6,
  static_cast<uint8_t>(KEY_Y),
  false}, HuffmanChar {HuffmanBits {{60}},
  6,
  static_cast<uint8_t>(MODIFIERKEY_SHIFT),
  true}, HuffmanChar {HuffmanBits {{69}},
  7,
  static_cast<uint8_t>(KEY_K),
  false}, HuffmanChar {HuffmanBits {{32}},
  7,
  static_cast<uint8_t>(KEY_X),
  false},
  HuffmanChar {HuffmanBits {{224}},
  8,
  static_cast<uint8_t>(KEY_J),
  false}, HuffmanChar {HuffmanBits {{133, 0}},
  9,
  static_cast<uint8_t>(KEY_Q),
  false}, HuffmanChar {HuffmanBits {{5, 1}},
  9,
  static_cast<uint8_t>(KEY_Z),
  false}, HuffmanChar {HuffmanBits {{5, 2}},
  10,
  static_cast<uint8_t>(KEY_QUOTE),
  false},
  HuffmanChar {HuffmanBits {{96, 0}},
  11,
  static_cast<uint8_t>(KEY_PERIOD),
  false}, HuffmanChar {HuffmanBits {{5, 0}},
  11,
  static_cast<uint8_t>(KEY_SPACE),
  false}, HuffmanChar {HuffmanBits {{96, 1}},
  12,
  static_cast<uint8_t>(BLANK_KEY),
  false}, HuffmanChar {HuffmanBits {{133, 5}},
  12,
  static_cast<uint8_t>(KEY_ESC),
  false},
  HuffmanChar {HuffmanBits {{133, 3}},
  12,
  static_cast<uint8_t>(MODIFIERKEY_CTRL),
  true}, HuffmanChar {HuffmanBits {{133, 25}},
  13,
  static_cast<uint8_t>(Command::command_switch_to),
  false}, HuffmanChar {HuffmanBits {{5, 4}},
  13,
  static_cast<uint8_t>(KEY_0),
  false}, HuffmanChar {HuffmanBits {{5, 28}},
  13,
  static_cast<uint8_t>(KEY_1),
  false},
  HuffmanChar {HuffmanBits {{133, 29}},
  13,
  static_cast<uint8_t>(KEY_2),
  false}, HuffmanChar {HuffmanBits {{5, 12}},
  13,
  static_cast<uint8_t>(KEY_3),
  false}, HuffmanChar {HuffmanBits {{5, 20}},
  13,
  static_cast<uint8_t>(KEY_4),
  false}, HuffmanChar {HuffmanBits {{133, 17}},
  13,
  static_cast<uint8_t>(KEY_5),
  false},
  HuffmanChar {HuffmanBits {{133, 1}},
  13,
  static_cast<uint8_t>(KEY_6),
  false}, HuffmanChar {HuffmanBits {{96, 26}},
  13,
  static_cast<uint8_t>(KEY_7),
  false}, HuffmanChar {HuffmanBits {{96, 31}},
  13,
  static_cast<uint8_t>(KEY_8),
  false}, HuffmanChar {HuffmanBits {{96, 25}},
  13,
  static_cast<uint8_t>(KEY_9),
  false},
  HuffmanChar {HuffmanBits {{96, 7}},
  13,
  static_cast<uint8_t>(KEY_BACKSLASH),
  false}, HuffmanChar {HuffmanBits {{96, 30}},
  13,
  static_cast<uint8_t>(KEY_COMMA),
  false}, HuffmanChar {HuffmanBits {{96, 29}},
  13,
  static_cast<uint8_t>(KEY_ENTER),
  false}, HuffmanChar {HuffmanBits {{133, 9}},
  13,
  static_cast<uint8_t>(KEY_EQUAL),
  false},
  HuffmanChar {HuffmanBits {{96, 10}},
  13,
  static_cast<uint8_t>(KEY_LEFT_BRACE),
  false}, HuffmanChar {HuffmanBits {{96, 5}},
  13,
  static_cast<uint8_t>(KEY_MINUS),
  false}, HuffmanChar {HuffmanBits {{96, 9}},
  13,
  static_cast<uint8_t>(KEY_PAGE_DOWN),
  false}, HuffmanChar {HuffmanBits {{96, 23}},
  13,
  static_cast<uint8_t>(KEY_PAGE_UP),
  false},
  HuffmanChar {HuffmanBits {{96, 6}},
  13,
  static_cast<uint8_t>(KEY_SEMICOLON),
  false}, HuffmanChar {HuffmanBits {{133, 7}},
  13,
  static_cast<uint8_t>(KEY_SLASH),
  false}, HuffmanChar {HuffmanBits {{96, 13}},
  13,
  static_cast<uint8_t>(MODIFIERKEY_ALT),
  true}, HuffmanChar {HuffmanBits {{96, 14}},
  14,
  static_cast<uint8_t>(Command::command_delete_word),
  false},
  HuffmanChar {HuffmanBits {{96, 34}},
  14,
  static_cast<uint8_t>(Command::command_led_battery),
  false}, HuffmanChar {HuffmanBits {{96, 3}},
  14,
  static_cast<uint8_t>(Command::command_left_limit),
  false}, HuffmanChar {HuffmanBits {{96, 22}},
  14,
  static_cast<uint8_t>(Command::command_left_word),
  false}, HuffmanChar {HuffmanBits {{96, 46}},
  14,
  static_cast<uint8_t>(Command::command_pan_left),
  false},
  HuffmanChar {HuffmanBits {{96, 4}},
  14,
  static_cast<uint8_t>(Command::command_right_limit),
  false}, HuffmanChar {HuffmanBits {{96, 59}},
  14,
  static_cast<uint8_t>(Command::command_scroll_down),
  false}, HuffmanChar {HuffmanBits {{96, 28}},
  14,
  static_cast<uint8_t>(Command::command_scroll_up),
  false}, HuffmanChar {HuffmanBits {{96, 27}},
  14,
  static_cast<uint8_t>(Command::command_shorten_last_word),
  false},
  HuffmanChar {HuffmanBits {{96, 35}},
  14,
  static_cast<uint8_t>(Command::command_sticky_alt),
  false}, HuffmanChar {HuffmanBits {{96, 19}},
  14,
  static_cast<uint8_t>(Command::command_sticky_ctrl),
  false}, HuffmanChar {HuffmanBits {{96, 54}},
  14,
  static_cast<uint8_t>(Command::command_sticky_gui),
  false}, HuffmanChar {HuffmanBits {{96, 12}},
  14,
  static_cast<uint8_t>(Command::command_sticky_shift),
  false},
  HuffmanChar {HuffmanBits {{96, 21}},
  14,
  static_cast<uint8_t>(KEY_BACKSPACE),
  false}, HuffmanChar {HuffmanBits {{96, 51}},
  14,
  static_cast<uint8_t>(KEY_CAPS_LOCK),
  false}, HuffmanChar {HuffmanBits {{96, 15}},
  14,
  static_cast<uint8_t>(KEY_DELETE),
  false}, HuffmanChar {HuffmanBits {{96, 44}},
  14,
  static_cast<uint8_t>(KEY_DOWN),
  false},
  HuffmanChar {HuffmanBits {{96, 11}},
  14,
  static_cast<uint8_t>(KEY_END),
  false}, HuffmanChar {HuffmanBits {{96, 50}},
  14,
  static_cast<uint8_t>(KEY_F1),
  false}, HuffmanChar {HuffmanBits {{96, 18}},
  14,
  static_cast<uint8_t>(KEY_F4),
  false}, HuffmanChar {HuffmanBits {{96, 2}},
  14,
  static_cast<uint8_t>(KEY_F6),
  false},
  HuffmanChar {HuffmanBits {{96, 36}},
  14,
  static_cast<uint8_t>(KEY_F7),
  false}, HuffmanChar {HuffmanBits {{96, 20}},
  14,
  static_cast<uint8_t>(KEY_HOME),
  false}, HuffmanChar {HuffmanBits {{96, 60}},
  14,
  static_cast<uint8_t>(KEY_LEFT),
  false}, HuffmanChar {HuffmanBits {{96, 53}},
  14,
  static_cast<uint8_t>(KEY_PRINTSCREEN),
  false},
  HuffmanChar {HuffmanBits {{133, 47}},
  14,
  static_cast<uint8_t>(KEY_RIGHT_BRACE),
  false}, HuffmanChar {HuffmanBits {{96, 47}},
  14,
  static_cast<uint8_t>(KEY_TAB),
  false}, HuffmanChar {HuffmanBits {{133, 31}},
  14,
  static_cast<uint8_t>(KEY_TILDE),
  false}, HuffmanChar {HuffmanBits {{96, 43}},
  14,
  static_cast<uint8_t>(KEY_UP),
  false},
  HuffmanChar {HuffmanBits {{96, 52}},
  14,
  static_cast<uint8_t>(Mode::windows_mode),
  false}, HuffmanChar {HuffmanBits {{133, 13}},
  15,
  static_cast<uint8_t>(Command::command_cycle_capital),
  false}, HuffmanChar {HuffmanBits {{133, 77}},
  15,
  static_cast<uint8_t>(Command::command_cycle_nospace),
  false}, HuffmanChar {HuffmanBits {{133, 127}},
  15,
  static_cast<uint8_t>(Command::command_cycle_word),
  false},
  HuffmanChar {HuffmanBits {{133, 45}},
  15,
  static_cast<uint8_t>(Command::command_led_colors),
  false}, HuffmanChar {HuffmanBits {{133, 79}},
  15,
  static_cast<uint8_t>(Command::command_led_rainbow),
  false}, HuffmanChar {HuffmanBits {{133, 59}},
  15,
  static_cast<uint8_t>(Command::command_pan_right),
  false}, HuffmanChar {HuffmanBits {{133, 27}},
  15,
  static_cast<uint8_t>(Command::command_pause),
  false},
  HuffmanChar {HuffmanBits {{133, 109}},
  15,
  static_cast<uint8_t>(Command::command_right_word),
  false}, HuffmanChar {HuffmanBits {{133, 63}},
  15,
  static_cast<uint8_t>(Command::command_toggle_wireless),
  false}, HuffmanChar {HuffmanBits {{133, 123}},
  15,
  static_cast<uint8_t>(Command::command_windows_mode),
  false}, HuffmanChar {HuffmanBits {{133, 23}},
  15,
  static_cast<uint8_t>(KEY_F2),
  false},
  HuffmanChar {HuffmanBits {{133, 91}},
  15,
  static_cast<uint8_t>(KEY_F3),
  false}, HuffmanChar {HuffmanBits {{133, 107}},
  15,
  static_cast<uint8_t>(KEY_F5),
  false}, HuffmanChar {HuffmanBits {{133, 43}},
  15,
  static_cast<uint8_t>(KEY_F8),
  false}, HuffmanChar {HuffmanBits {{133, 11}},
  15,
  static_cast<uint8_t>(KEY_F9),
  false},
  HuffmanChar {HuffmanBits {{133, 15}},
  15,
  static_cast<uint8_t>(KEY_RIGHT),
  false}, HuffmanChar {HuffmanBits {{133, 119}},
  15,
  static_cast<uint8_t>(MODIFIERKEY_GUI),
  true}, HuffmanChar {HuffmanBits {{133, 55}},
  15,
  static_cast<uint8_t>(Mode::default_mode),
  false}, HuffmanChar {HuffmanBits {{133, 75}},
  15,
  static_cast<uint8_t>(Mode::gaming_mode),
  false},
  HuffmanChar {HuffmanBits {{133, 87}},
  15,
...
c_array_t<ChordData, 1> const kmap0_Plain_len3_anagram0_chords = {ChordData {{16, 0, 0}}};

c_array_t<uint8_t, 1> const kmap0_Plain_len3_anagram0_seqs = {6};

LookupKmapTypeLenAnagram const kmap0_Plain_len3_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {3,
  0},
  1,
  kmap0_Plain_len3_anagram0_chords,
  kmap0_Plain_len3_anagram0_seqs};

c_array_t<ChordData, 9> const kmap0_Plain_len4_anagram0_chords = {ChordData {{0, 0, 1}}, ChordData {{0, 0, 2}}, ChordData {{0, 0, 8}}, ChordData {{0, 0, 16}},
  ChordData {{0, 0, 64}}, ChordData {{0, 0, 128}}, ChordData {{0, 4, 0}}, ChordData {{2, 0, 0}},
  ChordData {{128, 0, 0}}};

c_array_t<uint8_t, 5> const kmap0_Plain_len4_anagram0_seqs = {135, 186, 66, 63,
  9};
...
c_array_t<ChordData, 6> const kmap0_Plain_len5_anagram0_chords = {ChordData {{0, 8, 0}}, ChordData {{0, 32, 0}}, ChordData {{0, 64, 0}}, ChordData {{4, 0, 0}},
  ChordData {{32, 0, 0}}, ChordData {{32, 1, 0}}};

c_array_t<uint8_t, 4> const kmap0_Plain_len5_anagram0_seqs = {145, 133, 86, 33};
...
c_array_t<ChordData, 5> const kmap0_Plain_len6_anagram0_chords = {ChordData {{0, 0, 18}}, ChordData {{0, 1, 0}}, ChordData {{0, 64, 2}}, ChordData {{32, 8, 0}},
  ChordData {{36, 0, 0}}};

c_array_t<uint8_t, 4> const kmap0_Plain_len6_anagram0_seqs = {101, 7, 112, 61};
...
c_array_t<ChordData, 2> const kmap0_Plain_len7_anagram0_chords = {ChordData {{0, 0, 130}}, ChordData {{0, 9, 0}}};

c_array_t<uint8_t, 2> const kmap0_Plain_len7_anagram0_seqs = {160, 34};
...
c_array_t<ChordData, 1> const kmap0_Plain_len8_anagram0_chords = {ChordData {{0, 0, 144}}};

c_array_t<uint8_t, 1> const kmap0_Plain_len8_anagram0_seqs = {224};

LookupKmapTypeLenAnagram const kmap0_Plain_len8_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {8,
  0},
  1,
  kmap0_Plain_len8_anagram0_chords,
  kmap0_Plain_len8_anagram0_seqs};

c_array_t<ChordData, 2> const kmap0_Plain_len9_anagram0_chords = {ChordData {{0, 64, 128}}, ChordData {{4, 8, 0}}};

c_array_t<uint8_t, 3> const kmap0_Plain_len9_anagram0_seqs = {133, 10, 2};

LookupKmapTypeLenAnagram const kmap0_Plain_len9_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {9,
  0},
  2,
  kmap0_Plain_len9_anagram0_chords,
  kmap0_Plain_len9_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Plain_len10_anagram0_chords = {ChordData {{0, 32, 128}}};

c_array_t<uint8_t, 2> const kmap0_Plain_len10_anagram0_seqs = {5, 2};
...
c_array_t<ChordData, 2> const kmap0_Plain_len11_anagram0_chords = {ChordData {{0, 64, 16}}, ChordData {{0, 128, 0}}};

c_array_t<uint8_t, 3> const kmap0_Plain_len11_anagram0_seqs = {96, 40, 0};
...
c_array_t<ChordData, 1> const kmap0_Plain_len12_anagram0_chords = {ChordData {{16, 0, 1}}};

c_array_t<uint8_t, 2> const kmap0_Plain_len12_anagram0_seqs = {133, 5};

LookupKmapTypeLenAnagram const kmap0_Plain_len12_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {12,
  0},
  1,
  kmap0_Plain_len12_anagram0_chords,
  kmap0_Plain_len12_anagram0_seqs};

c_array_t<ChordData, 20> const kmap0_Plain_len13_anagram0_chords = {ChordData {{0, 0, 9}}, ChordData {{0, 0, 65}}, ChordData {{0, 0, 72}}, ChordData {{0, 2, 32}},
...
c_array_t<uint8_t, 33> const kmap0_Plain_len13_anagram0_seqs = {133, 29, 236, 23,
  80, 176, 84, 64,
  10, 79, 97, 0,
  43, 96, 10, 204,
  20, 38, 176, 11,
...
LookupKmapTypeLenAnagram const kmap0_Plain_len13_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {13,
  0},
  20,
  kmap0_Plain_len13_anagram0_chords,
  kmap0_Plain_len13_anagram0_seqs};

c_array_t<ChordData, 16> const kmap0_Plain_len14_anagram0_chords = {ChordData {{0, 0, 32}}, ChordData {{0, 0, 80}}, ChordData {{0, 1, 1}}, ChordData {{0, 2, 0}},
...
c_array_t<uint8_t, 28> const kmap0_Plain_len14_anagram0_seqs = {96, 107, 225, 87,
  248, 130, 177, 96,
  20, 216, 2, 86,
  131, 73, 96, 2,
  24, 15, 54, 131,
...
LookupKmapTypeLenAnagram const kmap0_Plain_len14_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  0},
  16,
  kmap0_Plain_len14_anagram0_chords,
  kmap0_Plain_len14_anagram0_seqs};

c_array_t<ChordData, 6> const kmap0_Plain_len15_anagram0_chords = {ChordData {{0, 128, 2}}, ChordData {{0, 129, 9}}, ChordData {{0, 129, 65}}, ChordData {{16, 133, 0}},
  ChordData {{128, 133, 0}}, ChordData {{144, 129, 0}}};

c_array_t<uint8_t, 12> const kmap0_Plain_len15_anagram0_seqs = {133, 143, 194, 75,
  225, 170, 112, 81,
  184, 46, 220, 2};

LookupKmapTypeLenAnagram const kmap0_Plain_len15_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {15,
  0},
  6,
  kmap0_Plain_len15_anagram0_chords,
  kmap0_Plain_len15_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Plain_len16_anagram0_chords = {ChordData {{2, 8, 0}}};

c_array_t<uint8_t, 2> const kmap0_Plain_len16_anagram0_seqs = {124, 129};

LookupKmapTypeLenAnagram const kmap0_Plain_len16_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {16,
  0},
  1,
  kmap0_Plain_len16_anagram0_chords,
  kmap0_Plain_len16_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Plain_len17_anagram0_chords = {ChordData {{0, 8, 1}}};

c_array_t<uint8_t, 3> const kmap0_Plain_len17_anagram0_seqs = {60, 24, 0};

LookupKmapTypeLenAnagram const kmap0_Plain_len17_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {17,
  0},
  1,
  kmap0_Plain_len17_anagram0_chords,
  kmap0_Plain_len17_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Plain_len18_anagram0_chords = {ChordData {{64, 0, 0}}};

c_array_t<uint8_t, 3> const kmap0_Plain_len18_anagram0_seqs = {60, 88, 0};

LookupKmapTypeLenAnagram const kmap0_Plain_len18_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {18,
  0},
  1,
  kmap0_Plain_len18_anagram0_chords,
  kmap0_Plain_len18_anagram0_seqs};

c_array_t<ChordData, 17> const kmap0_Plain_len19_anagram0_chords = {ChordData {{0, 0, 10}}, ChordData {{0, 0, 17}}, ChordData {{0, 0, 66}}, ChordData {{0, 32, 64}},
...
c_array_t<uint8_t, 41> const kmap0_Plain_len19_anagram0_seqs = {124, 97, 228, 193,
  52, 95, 192, 248,
  194, 195, 131, 121,
  190, 128, 242, 96,
  133, 47, 224, 124,
...
LookupKmapTypeLenAnagram const kmap0_Plain_len19_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {19,
  0},
  17,
  kmap0_Plain_len19_anagram0_chords,
  kmap0_Plain_len19_anagram0_seqs};

c_array_t<ChordData, 2> const kmap0_Plain_len20_anagram0_chords = {ChordData {{0, 5, 0}}, ChordData {{32, 0, 1}}};

c_array_t<uint8_t, 5> const kmap0_Plain_len20_anagram0_seqs = {124, 225, 199, 23,
  190};

LookupKmapTypeLenAnagram const kmap0_Plain_len20_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {20,
  0},
  2,
  kmap0_Plain_len20_anagram0_chords,
  kmap0_Plain_len20_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Plain_len24_anagram0_chords = {ChordData {{1, 0, 0}}};

c_array_t<uint8_t, 3> const kmap0_Plain_len24_anagram0_seqs = {133, 3, 22};

LookupKmapTypeLenAnagram const kmap0_Plain_len24_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {24,
  0},
  1,
  kmap0_Plain_len24_anagram0_chords,
  kmap0_Plain_len24_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Plain_len25_anagram0_chords = {ChordData {{0, 0, 4}}};

c_array_t<uint8_t, 4> const kmap0_Plain_len25_anagram0_seqs = {96, 13, 44, 0};

LookupKmapTypeLenAnagram const kmap0_Plain_len25_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {25,
  0},
  1,
  kmap0_Plain_len25_anagram0_chords,
  kmap0_Plain_len25_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Plain_len27_anagram0_chords = {ChordData {{0, 16, 0}}};

c_array_t<uint8_t, 4> const kmap0_Plain_len27_anagram0_seqs = {133, 119, 176, 0};

LookupKmapTypeLenAnagram const kmap0_Plain_len27_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {27,
  0},
  1,
  kmap0_Plain_len27_anagram0_chords,
  kmap0_Plain_len27_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 21> const kmap0_Plain_lookups_array = {&kmap0_Plain_len3_anagram0, &kmap0_Plain_len4_anagram0, &kmap0_Plain_len5_anagram0, &kmap0_Plain_len6_anagram0,
...
LookupKmapType const kmap0_Plain_lookups = LookupKmapType {21,
  kmap0_Plain_lookups_array};

c_array_t<ChordData, 1> const kmap0_Macro_len16_anagram0_chords = {ChordData {{0, 132, 0}}};

c_array_t<uint8_t, 2> const kmap0_Macro_len16_anagram0_seqs = {133, 243};

LookupKmapTypeLenAnagram const kmap0_Macro_len16_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {16,
  0},
  1,
  kmap0_Macro_len16_anagram0_chords,
  kmap0_Macro_len16_anagram0_seqs};

c_array_t<ChordData, 2> const kmap0_Macro_len20_anagram0_chords = {ChordData {{0, 96, 0}}, ChordData {{6, 0, 0}}};

c_array_t<uint8_t, 5> const kmap0_Macro_len20_anagram0_seqs = {96, 13, 84, 56,
  56};

LookupKmapTypeLenAnagram const kmap0_Macro_len20_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {20,
  0},
  2,
  kmap0_Macro_len20_anagram0_chords,
  kmap0_Macro_len20_anagram0_seqs};

c_array_t<ChordData, 3> const kmap0_Macro_len25_anagram0_chords = {ChordData {{0, 128, 8}}, ChordData {{0, 128, 64}}, ChordData {{36, 192, 2}}};

c_array_t<uint8_t, 10> const kmap0_Macro_len25_anagram0_seqs = {133, 3, 118, 11,
  7, 44, 21, 158,
  194, 2};

LookupKmapTypeLenAnagram const kmap0_Macro_len25_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {25,
  0},
  3,
  kmap0_Macro_len25_anagram0_chords,
  kmap0_Macro_len25_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Macro_len26_anagram0_chords = {ChordData {{6, 128, 0}}};

c_array_t<uint8_t, 4> const kmap0_Macro_len26_anagram0_seqs = {133, 131, 252, 0};

LookupKmapTypeLenAnagram const kmap0_Macro_len26_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {26,
  0},
  1,
  kmap0_Macro_len26_anagram0_chords,
  kmap0_Macro_len26_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Macro_len27_anagram0_chords = {ChordData {{16, 132, 1}}};

c_array_t<uint8_t, 4> const kmap0_Macro_len27_anagram0_seqs = {95, 128, 194, 2};

LookupKmapTypeLenAnagram const kmap0_Macro_len27_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {27,
  0},
  1,
  kmap0_Macro_len27_anagram0_chords,
  kmap0_Macro_len27_anagram0_seqs};

c_array_t<ChordData, 2> const kmap0_Macro_len32_anagram0_chords = {ChordData {{0, 192, 128}}, ChordData {{20, 132, 1}}};

c_array_t<uint8_t, 8> const kmap0_Macro_len32_anagram0_seqs = {133, 3, 42, 224,
  95, 128, 194, 106};

LookupKmapTypeLenAnagram const kmap0_Macro_len32_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {32,
  0},
  2,
  kmap0_Macro_len32_anagram0_chords,
  kmap0_Macro_len32_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Macro_len33_anagram0_chords = {ChordData {{80, 132, 1}}};

c_array_t<uint8_t, 5> const kmap0_Macro_len33_anagram0_seqs = {252, 23, 160, 176,
  0};

LookupKmapTypeLenAnagram const kmap0_Macro_len33_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {33,
  0},
  1,
  kmap0_Macro_len33_anagram0_chords,
  kmap0_Macro_len33_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Macro_len38_anagram0_chords = {ChordData {{84, 132, 1}}};

c_array_t<uint8_t, 5> const kmap0_Macro_len38_anagram0_seqs = {252, 23, 160, 176,
  26};

LookupKmapTypeLenAnagram const kmap0_Macro_len38_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {38,
  0},
  1,
  kmap0_Macro_len38_anagram0_chords,
  kmap0_Macro_len38_anagram0_seqs};

c_array_t<ChordData, 1> const kmap0_Macro_len43_anagram0_chords = {ChordData {{0, 132, 130}}};

c_array_t<uint8_t, 6> const kmap0_Macro_len43_anagram0_seqs = {133, 3, 42, 172,
  194, 2};

LookupKmapTypeLenAnagram const kmap0_Macro_len43_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {43,
  0},
  1,
  kmap0_Macro_len43_anagram0_chords,
  kmap0_Macro_len43_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 9> const kmap0_Macro_lookups_array = {&kmap0_Macro_len16_anagram0, &kmap0_Macro_len20_anagram0, &kmap0_Macro_len25_anagram0, &kmap0_Macro_len26_anagram0,
...
LookupKmapType const kmap0_Macro_lookups = LookupKmapType {9,
  kmap0_Macro_lookups_array};

c_array_t<ChordData, 6> const kmap0_Command_len14_anagram0_chords = {ChordData {{0, 32, 9}}, ChordData {{0, 192, 1}}, ChordData {{20, 128, 0}}, ChordData {{36, 128, 0}},
  ChordData {{36, 169, 0}}, ChordData {{146, 16, 0}}};

c_array_t<uint8_t, 11> const kmap0_Command_len14_anagram0_seqs = {96, 14, 24, 1,
  54, 128, 89, 96,
  34, 216, 6};

LookupKmapTypeLenAnagram const kmap0_Command_len14_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  0},
  6,
  kmap0_Command_len14_anagram0_chords,
  kmap0_Command_len14_anagram0_seqs};

c_array_t<ChordData, 7> const kmap0_Command_len15_anagram0_chords = {ChordData {{0, 192, 2}}, ChordData {{36, 73, 146}}, ChordData {{36, 137, 2}}, ChordData {{36, 137, 16}},
  ChordData {{146, 0, 0}}, ChordData {{146, 0, 4}}, ChordData {{210, 0, 0}}};

c_array_t<uint8_t, 14> const kmap0_Command_len15_anagram0_seqs = {133, 237, 194, 77,
  97, 171, 240, 89,
  248, 47, 108, 22,
  54, 0};

LookupKmapTypeLenAnagram const kmap0_Command_len15_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {15,
  0},
  7,
  kmap0_Command_len15_anagram0_chords,
  kmap0_Command_len15_anagram0_seqs};

c_array_t<ChordData, 2> const kmap0_Command_len28_anagram0_chords = {ChordData {{0, 64, 146}}, ChordData {{36, 9, 0}}};

c_array_t<uint8_t, 7> const kmap0_Command_len28_anagram0_seqs = {133, 185, 112, 89,
  152, 11, 175};

LookupKmapTypeLenAnagram const kmap0_Command_len28_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {28,
  0},
  2,
  kmap0_Command_len28_anagram0_chords,
  kmap0_Command_len28_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 3> const kmap0_Command_lookups_array = {&kmap0_Command_len14_anagram0, &kmap0_Command_len15_anagram0, &kmap0_Command_len28_anagram0};

LookupKmapType const kmap0_Command_lookups = LookupKmapType {3,
...
c_array_t<ChordData, 1> const kmap1_Plain_len3_anagram0_chords = {ChordData {{4, 0, 0}}};

c_array_t<uint8_t, 1> const kmap1_Plain_len3_anagram0_seqs = {6};

LookupKmapTypeLenAnagram const kmap1_Plain_len3_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {3,
  0},
  1,
  kmap1_Plain_len3_anagram0_chords,
  kmap1_Plain_len3_anagram0_seqs};

c_array_t<ChordData, 2> const kmap1_Plain_len4_anagram0_chords = {ChordData {{16, 0, 0}}, ChordData {{128, 0, 0}}};

c_array_t<uint8_t, 1> const kmap1_Plain_len4_anagram0_seqs = {242};

LookupKmapTypeLenAnagram const kmap1_Plain_len4_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {4,
  0},
  2,
  kmap1_Plain_len4_anagram0_chords,
  kmap1_Plain_len4_anagram0_seqs};

c_array_t<ChordData, 1> const kmap1_Plain_len5_anagram0_chords = {ChordData {{2, 0, 0}}};

c_array_t<uint8_t, 1> const kmap1_Plain_len5_anagram0_seqs = {1};

LookupKmapTypeLenAnagram const kmap1_Plain_len5_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {5,
  0},
  1,
  kmap1_Plain_len5_anagram0_chords,
  kmap1_Plain_len5_anagram0_seqs};

c_array_t<ChordData, 1> const kmap1_Plain_len6_anagram0_chords = {ChordData {{32, 0, 0}}};

c_array_t<uint8_t, 1> const kmap1_Plain_len6_anagram0_seqs = {0};

LookupKmapTypeLenAnagram const kmap1_Plain_len6_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {6,
  0},
  1,
  kmap1_Plain_len6_anagram0_chords,
  kmap1_Plain_len6_anagram0_seqs};

c_array_t<ChordData, 1> const kmap1_Plain_len9_anagram0_chords = {ChordData {{0, 1, 0}}};

c_array_t<uint8_t, 2> const kmap1_Plain_len9_anagram0_seqs = {133, 0};

LookupKmapTypeLenAnagram const kmap1_Plain_len9_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {9,
  0},
  1,
  kmap1_Plain_len9_anagram0_chords,
  kmap1_Plain_len9_anagram0_seqs};

c_array_t<ChordData, 1> const kmap1_Plain_len11_anagram0_chords = {ChordData {{8, 0, 0}}};

c_array_t<uint8_t, 2> const kmap1_Plain_len11_anagram0_seqs = {5, 0};

LookupKmapTypeLenAnagram const kmap1_Plain_len11_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {11,
  0},
  1,
  kmap1_Plain_len11_anagram0_chords,
  kmap1_Plain_len11_anagram0_seqs};

c_array_t<ChordData, 1> const kmap1_Plain_len14_anagram0_chords = {ChordData {{0, 8, 0}}};

c_array_t<uint8_t, 2> const kmap1_Plain_len14_anagram0_seqs = {96, 47};

LookupKmapTypeLenAnagram const kmap1_Plain_len14_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  0},
  1,
  kmap1_Plain_len14_anagram0_chords,
  kmap1_Plain_len14_anagram0_seqs};

c_array_t<ChordData, 1> const kmap1_Plain_len18_anagram0_chords = {ChordData {{0, 4, 0}}};

c_array_t<uint8_t, 3> const kmap1_Plain_len18_anagram0_seqs = {60, 88, 0};

LookupKmapTypeLenAnagram const kmap1_Plain_len18_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {18,
  0},
  1,
  kmap1_Plain_len18_anagram0_chords,
  kmap1_Plain_len18_anagram0_seqs};

c_array_t<ChordData, 1> const kmap1_Plain_len24_anagram0_chords = {ChordData {{1, 0, 0}}};

c_array_t<uint8_t, 3> const kmap1_Plain_len24_anagram0_seqs = {133, 3, 22};

LookupKmapTypeLenAnagram const kmap1_Plain_len24_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {24,
  0},
  1,
  kmap1_Plain_len24_anagram0_chords,
  kmap1_Plain_len24_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 9> const kmap1_Plain_lookups_array = {&kmap1_Plain_len3_anagram0, &kmap1_Plain_len4_anagram0, &kmap1_Plain_len5_anagram0, &kmap1_Plain_len6_anagram0,
...
LookupKmapType const kmap1_Plain_lookups = LookupKmapType {9,
...
c_array_t<ChordData, 1> const kmap1_Command_len28_anagram0_chords = {ChordData {{0, 0, 1}}};

c_array_t<uint8_t, 4> const kmap1_Command_len28_anagram0_seqs = {133, 185, 240, 6};

LookupKmapTypeLenAnagram const kmap1_Command_len28_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {28,
  0},
  1,
  kmap1_Command_len28_anagram0_chords,
  kmap1_Command_len28_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 1> const kmap1_Command_lookups_array = {&kmap1_Command_len28_anagram0};

LookupKmapType const kmap1_Command_lookups = LookupKmapType {1,
  kmap1_Command_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap1_Word_lookups_array = {};

LookupKmapType const kmap1_Word_lookups = LookupKmapType {0,
...
c_array_t<ChordData, 1> const kmap2_Plain_len3_anagram0_chords = {ChordData {{16, 0, 0}}};

c_array_t<uint8_t, 1> const kmap2_Plain_len3_anagram0_seqs = {6};

LookupKmapTypeLenAnagram const kmap2_Plain_len3_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {3,
  0},
  1,
  kmap2_Plain_len3_anagram0_chords,
  kmap2_Plain_len3_anagram0_seqs};

c_array_t<ChordData, 9> const kmap2_Plain_len4_anagram0_chords = {ChordData {{0, 4, 0}}, ChordData {{2, 0, 0}}, ChordData {{64, 1, 0}}, ChordData {{64, 4, 0}},
  ChordData {{64, 8, 0}}, ChordData {{80, 0, 0}}, ChordData {{96, 0, 0}}, ChordData {{128, 0, 0}},
  ChordData {{192, 0, 0}}};

c_array_t<uint8_t, 5> const kmap2_Plain_len4_anagram0_seqs = {63, 43, 116, 152,
  10};

LookupKmapTypeLenAnagram const kmap2_Plain_len4_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {4,
  0},
  9,
  kmap2_Plain_len4_anagram0_chords,
  kmap2_Plain_len4_anagram0_seqs};

c_array_t<ChordData, 6> const kmap2_Plain_len5_anagram0_chords = {ChordData {{0, 8, 0}}, ChordData {{4, 0, 0}}, ChordData {{32, 0, 0}}, ChordData {{32, 1, 0}},
  ChordData {{66, 0, 0}}, ChordData {{68, 0, 0}}};

c_array_t<uint8_t, 4> const kmap2_Plain_len5_anagram0_seqs = {177, 85, 200, 2};

LookupKmapTypeLenAnagram const kmap2_Plain_len5_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {5,
  0},
  6,
  kmap2_Plain_len5_anagram0_chords,
  kmap2_Plain_len5_anagram0_seqs};

c_array_t<ChordData, 5> const kmap2_Plain_len6_anagram0_chords = {ChordData {{0, 1, 0}}, ChordData {{32, 8, 0}}, ChordData {{36, 0, 0}}, ChordData {{96, 1, 0}},
  ChordData {{100, 0, 0}}};

c_array_t<uint8_t, 4> const kmap2_Plain_len6_anagram0_seqs = {29, 215, 151, 0};

LookupKmapTypeLenAnagram const kmap2_Plain_len6_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {6,
  0},
  5,
  kmap2_Plain_len6_anagram0_chords,
  kmap2_Plain_len6_anagram0_seqs};

c_array_t<ChordData, 2> const kmap2_Plain_len7_anagram0_chords = {ChordData {{0, 9, 0}}, ChordData {{96, 8, 0}}};

c_array_t<uint8_t, 2> const kmap2_Plain_len7_anagram0_seqs = {69, 16};

LookupKmapTypeLenAnagram const kmap2_Plain_len7_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {7,
  0},
  2,
  kmap2_Plain_len7_anagram0_chords,
  kmap2_Plain_len7_anagram0_seqs};

c_array_t<ChordData, 1> const kmap2_Plain_len8_anagram0_chords = {ChordData {{64, 9, 0}}};

c_array_t<uint8_t, 1> const kmap2_Plain_len8_anagram0_seqs = {224};

LookupKmapTypeLenAnagram const kmap2_Plain_len8_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {8,
  0},
  1,
  kmap2_Plain_len8_anagram0_chords,
  kmap2_Plain_len8_anagram0_seqs};

c_array_t<ChordData, 2> const kmap2_Plain_len9_anagram0_chords = {ChordData {{4, 8, 0}}, ChordData {{68, 8, 0}}};

c_array_t<uint8_t, 3> const kmap2_Plain_len9_anagram0_seqs = {5, 11, 1};

LookupKmapTypeLenAnagram const kmap2_Plain_len9_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {9,
  0},
  2,
  kmap2_Plain_len9_anagram0_chords,
  kmap2_Plain_len9_anagram0_seqs};

c_array_t<ChordData, 1> const kmap2_Plain_len10_anagram0_chords = {ChordData {{66, 8, 0}}};

c_array_t<uint8_t, 2> const kmap2_Plain_len10_anagram0_seqs = {5, 2};

LookupKmapTypeLenAnagram const kmap2_Plain_len10_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {10,
  0},
  1,
  kmap2_Plain_len10_anagram0_chords,
  kmap2_Plain_len10_anagram0_seqs};

c_array_t<ChordData, 2> const kmap2_Plain_len11_anagram0_chords = {ChordData {{64, 0, 0}}, ChordData {{68, 1, 0}}};

c_array_t<uint8_t, 3> const kmap2_Plain_len11_anagram0_seqs = {5, 0, 3};

LookupKmapTypeLenAnagram const kmap2_Plain_len11_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {11,
  0},
  2,
  kmap2_Plain_len11_anagram0_chords,
  kmap2_Plain_len11_anagram0_seqs};

c_array_t<ChordData, 1> const kmap2_Plain_len12_anagram0_chords = {ChordData {{19, 0, 0}}};

c_array_t<uint8_t, 2> const kmap2_Plain_len12_anagram0_seqs = {133, 5};

LookupKmapTypeLenAnagram const kmap2_Plain_len12_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {12,
  0},
  1,
  kmap2_Plain_len12_anagram0_chords,
  kmap2_Plain_len12_anagram0_seqs};

c_array_t<ChordData, 19> const kmap2_Plain_len13_anagram0_chords = {ChordData {{1, 0, 0}}, ChordData {{4, 1, 0}}, ChordData {{6, 0, 0}}, ChordData {{16, 4, 0}},
...
c_array_t<uint8_t, 31> const kmap2_Plain_len13_anagram0_seqs = {96, 29, 204, 131,
  93, 176, 92, 192,
  193, 14, 88, 2,
  43, 133, 9, 236,
  23, 144, 194, 83,
...
LookupKmapTypeLenAnagram const kmap2_Plain_len13_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {13,
  0},
  19,
  kmap2_Plain_len13_anagram0_chords,
  kmap2_Plain_len13_anagram0_seqs};

c_array_t<ChordData, 14> const kmap2_Plain_len14_anagram0_chords = {ChordData {{0, 2, 0}}, ChordData {{1, 1, 0}}, ChordData {{1, 8, 0}}, ChordData {{8, 0, 0}},
...
c_array_t<uint8_t, 25> const kmap2_Plain_len14_anagram0_seqs = {96, 44, 216, 2,
  70, 129, 85, 96,
  50, 24, 15, 246,
  128, 173, 133, 31,
  216, 11, 54, 131,
...
LookupKmapTypeLenAnagram const kmap2_Plain_len14_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  0},
  14,
  kmap2_Plain_len14_anagram0_chords,
  kmap2_Plain_len14_anagram0_seqs};

c_array_t<ChordData, 6> const kmap2_Plain_len15_anagram0_chords = {ChordData {{5, 0, 0}}, ChordData {{16, 5, 0}}, ChordData {{80, 5, 0}}, ChordData {{128, 5, 0}},
  ChordData {{144, 1, 0}}, ChordData {{208, 1, 0}}};

c_array_t<uint8_t, 12> const kmap2_Plain_len15_anagram0_seqs = {133, 143, 194, 69,
  225, 170, 112, 93,
  184, 45, 188, 0};

LookupKmapTypeLenAnagram const kmap2_Plain_len15_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {15,
  0},
  6,
  kmap2_Plain_len15_anagram0_chords,
  kmap2_Plain_len15_anagram0_seqs};

c_array_t<ChordData, 1> const kmap2_Plain_len16_anagram0_chords = {ChordData {{2, 8, 0}}};

c_array_t<uint8_t, 2> const kmap2_Plain_len16_anagram0_seqs = {124, 129};

LookupKmapTypeLenAnagram const kmap2_Plain_len16_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {16,
  0},
  1,
  kmap2_Plain_len16_anagram0_chords,
  kmap2_Plain_len16_anagram0_seqs};

c_array_t<ChordData, 13> const kmap2_Plain_len19_anagram0_chords = {ChordData {{2, 1, 0}}, ChordData {{2, 4, 0}}, ChordData {{4, 4, 0}}, ChordData {{16, 1, 0}},
...
c_array_t<uint8_t, 31> const kmap2_Plain_len19_anagram0_seqs = {60, 88, 225, 11,
  56, 95, 152, 120,
  176, 195, 23, 6,
  190, 176, 243, 133,
  135, 7, 211, 124,
...
LookupKmapTypeLenAnagram const kmap2_Plain_len19_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {19,
  0},
  13,
  kmap2_Plain_len19_anagram0_chords,
  kmap2_Plain_len19_anagram0_seqs};

c_array_t<ChordData, 1> const kmap2_Plain_len20_anagram0_chords = {ChordData {{0, 5, 0}}};

c_array_t<uint8_t, 3> const kmap2_Plain_len20_anagram0_seqs = {124, 225, 7};

LookupKmapTypeLenAnagram const kmap2_Plain_len20_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {20,
  0},
  1,
  kmap2_Plain_len20_anagram0_chords,
  kmap2_Plain_len20_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 16> const kmap2_Plain_lookups_array = {&kmap2_Plain_len3_anagram0, &kmap2_Plain_len4_anagram0, &kmap2_Plain_len5_anagram0, &kmap2_Plain_len6_anagram0,
...
LookupKmapType const kmap2_Plain_lookups = LookupKmapType {16,
  kmap2_Plain_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap2_Macro_lookups_array = {};

LookupKmapType const kmap2_Macro_lookups = LookupKmapType {0,
  kmap2_Macro_lookups_array};

c_array_t<ChordData, 4> const kmap2_Command_len14_anagram0_chords = {ChordData {{1, 4, 0}}, ChordData {{3, 0, 0}}, ChordData {{17, 0, 0}}, ChordData {{129, 0, 0}}};

c_array_t<uint8_t, 7> const kmap2_Command_len14_anagram0_seqs = {96, 35, 216, 4,
  102, 131, 49};

LookupKmapTypeLenAnagram const kmap2_Command_len14_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  0},
  4,
  kmap2_Command_len14_anagram0_chords,
  kmap2_Command_len14_anagram0_seqs};

c_array_t<ChordData, 1> const kmap2_Command_len28_anagram0_chords = {ChordData {{16, 0, 1}}};

c_array_t<uint8_t, 4> const kmap2_Command_len28_anagram0_seqs = {133, 185, 240, 6};

LookupKmapTypeLenAnagram const kmap2_Command_len28_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {28,
  0},
  1,
  kmap2_Command_len28_anagram0_chords,
  kmap2_Command_len28_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 2> const kmap2_Command_lookups_array = {&kmap2_Command_len14_anagram0, &kmap2_Command_len28_anagram0};

LookupKmapType const kmap2_Command_lookups = LookupKmapType {2,
  kmap2_Command_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap2_Word_lookups_array = {};

LookupKmapType const kmap2_Word_lookups = LookupKmapType {0,
  kmap2_Word_lookups_array};

c_array_t<LookupKmapType const*, 4> const kmap2_lookups_array = {&kmap2_Plain_lookups, &kmap2_Macro_lookups, &kmap2_Command_lookups, &kmap2_Word_lookups};

KmapStruct const kmap2_lookups = KmapStruct {kmap2_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap3_Plain_lookups_array = {};

LookupKmapType const kmap3_Plain_lookups = LookupKmapType {0,
  kmap3_Plain_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap3_Macro_lookups_array = {};

LookupKmapType const kmap3_Macro_lookups = LookupKmapType {0,
  kmap3_Macro_lookups_array};

c_array_t<ChordData, 1> const kmap3_Command_len28_anagram0_chords = {ChordData {{36, 9, 0}}};

c_array_t<uint8_t, 4> const kmap3_Command_len28_anagram0_seqs = {133, 185, 240, 6};

LookupKmapTypeLenAnagram const kmap3_Command_len28_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {28,
  0},
  1,
  kmap3_Command_len28_anagram0_chords,
  kmap3_Command_len28_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 1> const kmap3_Command_lookups_array = {&kmap3_Command_len28_anagram0};

LookupKmapType const kmap3_Command_lookups = LookupKmapType {1,
  kmap3_Command_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap3_Word_lookups_array = {};

LookupKmapType const kmap3_Word_lookups = LookupKmapType {0,
  kmap3_Word_lookups_array};

c_array_t<LookupKmapType const*, 4> const kmap3_lookups_array = {&kmap3_Plain_lookups, &kmap3_Macro_lookups, &kmap3_Command_lookups, &kmap3_Word_lookups};

KmapStruct const kmap3_lookups = KmapStruct {kmap3_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap4_Plain_lookups_array = {};

LookupKmapType const kmap4_Plain_lookups = LookupKmapType {0,
  kmap4_Plain_lookups_array};

c_array_t<ChordData, 1> const kmap4_Macro_len21_anagram0_chords = {ChordData {{0, 128, 192}}};

c_array_t<uint8_t, 3> const kmap4_Macro_len21_anagram0_seqs = {36, 96, 29};

LookupKmapTypeLenAnagram const kmap4_Macro_len21_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {21,
  0},
  1,
  kmap4_Macro_len21_anagram0_chords,
  kmap4_Macro_len21_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 1> const kmap4_Macro_lookups_array = {&kmap4_Macro_len21_anagram0};

LookupKmapType const kmap4_Macro_lookups = LookupKmapType {1,
  kmap4_Macro_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap4_Command_lookups_array = {};

LookupKmapType const kmap4_Command_lookups = LookupKmapType {0,
  kmap4_Command_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap4_Word_lookups_array = {};

LookupKmapType const kmap4_Word_lookups = LookupKmapType {0,
  kmap4_Word_lookups_array};

c_array_t<LookupKmapType const*, 4> const kmap4_lookups_array = {&kmap4_Plain_lookups, &kmap4_Macro_lookups, &kmap4_Command_lookups, &kmap4_Word_lookups};

KmapStruct const kmap4_lookups = KmapStruct {kmap4_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap5_Plain_lookups_array = {};

LookupKmapType const kmap5_Plain_lookups = LookupKmapType {0,
  kmap5_Plain_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap5_Macro_lookups_array = {};

LookupKmapType const kmap5_Macro_lookups = LookupKmapType {0,
  kmap5_Macro_lookups_array};

c_array_t<LookupKmapTypeLenAnagram const*, 0> const kmap5_Command_lookups_array = {};

LookupKmapType const kmap5_Command_lookups = LookupKmapType {0,
  kmap5_Command_lookups_array};

c_array_t<ChordData, 3> const kmap5_Word_len4_anagram1_chords = {ChordData {{0, 0, 16}}, ChordData {{0, 0, 64}}, ChordData {{0, 4, 0}}};

c_array_t<uint8_t, 2> const kmap5_Word_len4_anagram1_seqs = {43, 15};

LookupKmapTypeLenAnagram const kmap5_Word_len4_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {4,
  1},
  3,
  kmap5_Word_len4_anagram1_chords,
  kmap5_Word_len4_anagram1_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len5_anagram1_chords = {ChordData {{0, 64, 0}}, ChordData {{32, 0, 0}}};

c_array_t<uint8_t, 2> const kmap5_Word_len5_anagram1_seqs = {161, 2};

LookupKmapTypeLenAnagram const kmap5_Word_len5_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {5,
  1},
  2,
  kmap5_Word_len5_anagram1_chords,
  kmap5_Word_len5_anagram1_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len7_anagram0_chords = {ChordData {{16, 0, 8}}, ChordData {{16, 0, 16}}};

c_array_t<uint8_t, 2> const kmap5_Word_len7_anagram0_seqs = {86, 47};

LookupKmapTypeLenAnagram const kmap5_Word_len7_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {7,
  0},
  2,
  kmap5_Word_len7_anagram0_chords,
  kmap5_Word_len7_anagram0_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len7_anagram1_chords = {ChordData {{0, 0, 130}}, ChordData {{16, 0, 16}}, ChordData {{16, 0, 64}}};

c_array_t<uint8_t, 3> const kmap5_Word_len7_anagram1_seqs = {160, 181, 5};

LookupKmapTypeLenAnagram const kmap5_Word_len7_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {7,
  1},
  3,
  kmap5_Word_len7_anagram1_chords,
  kmap5_Word_len7_anagram1_seqs};

c_array_t<ChordData, 18> const kmap5_Word_len8_anagram0_chords = {ChordData {{0, 0, 136}}, ChordData {{0, 0, 192}}, ChordData {{0, 4, 1}}, ChordData {{0, 4, 2}},
...
c_array_t<uint8_t, 18> const kmap5_Word_len8_anagram0_seqs = {164, 36, 127, 143,
  175, 47, 115, 131,
  163, 35, 209, 204,
  14, 151, 152, 169,
  185, 146};

LookupKmapTypeLenAnagram const kmap5_Word_len8_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {8,
  0},
  18,
  kmap5_Word_len8_anagram0_chords,
  kmap5_Word_len8_anagram0_seqs};

c_array_t<ChordData, 4> const kmap5_Word_len8_anagram1_chords = {ChordData {{0, 4, 128}}, ChordData {{16, 8, 0}}, ChordData {{16, 64, 0}}, ChordData {{128, 0, 8}}};

c_array_t<uint8_t, 4> const kmap5_Word_len8_anagram1_seqs = {79, 142, 193, 154};

LookupKmapTypeLenAnagram const kmap5_Word_len8_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {8,
  1},
  4,
  kmap5_Word_len8_anagram1_chords,
  kmap5_Word_len8_anagram1_seqs};

c_array_t<ChordData, 12> const kmap5_Word_len9_anagram0_chords = {ChordData {{0, 8, 16}}, ChordData {{0, 12, 0}}, ChordData {{0, 36, 0}}, ChordData {{2, 32, 0}},
...
c_array_t<uint8_t, 14> const kmap5_Word_len9_anagram0_seqs = {27, 63, 62, 99,
  211, 4, 112, 213,
  42, 189, 147, 133,
  132, 9};

LookupKmapTypeLenAnagram const kmap5_Word_len9_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {9,
  0},
  12,
  kmap5_Word_len9_anagram0_chords,
  kmap5_Word_len9_anagram0_seqs};

c_array_t<ChordData, 6> const kmap5_Word_len9_anagram1_chords = {ChordData {{0, 36, 0}}, ChordData {{0, 64, 2}}, ChordData {{2, 8, 0}}, ChordData {{6, 0, 0}},
  ChordData {{32, 1, 8}}, ChordData {{132, 0, 0}}};

c_array_t<uint8_t, 7> const kmap5_Word_len9_anagram1_seqs = {236, 49, 76, 108,
  163, 48, 27};

LookupKmapTypeLenAnagram const kmap5_Word_len9_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {9,
  1},
  6,
  kmap5_Word_len9_anagram1_chords,
  kmap5_Word_len9_anagram1_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len9_anagram2_chords = {ChordData {{4, 4, 0}}, ChordData {{6, 0, 0}}};

c_array_t<uint8_t, 3> const kmap5_Word_len9_anagram2_seqs = {223, 166, 1};

LookupKmapTypeLenAnagram const kmap5_Word_len9_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {9,
  2},
  2,
  kmap5_Word_len9_anagram2_chords,
  kmap5_Word_len9_anagram2_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len9_anagram4_chords = {ChordData {{34, 1, 0}}};

c_array_t<uint8_t, 2> const kmap5_Word_len9_anagram4_seqs = {112, 0};

LookupKmapTypeLenAnagram const kmap5_Word_len9_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {9,
  4},
  1,
  kmap5_Word_len9_anagram4_chords,
  kmap5_Word_len9_anagram4_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len10_anagram0_chords = {ChordData {{0, 0, 146}}, ChordData {{0, 1, 8}}, ChordData {{16, 0, 64}}, ChordData {{38, 0, 0}},
  ChordData {{128, 1, 0}}};

c_array_t<uint8_t, 7> const kmap5_Word_len10_anagram0_seqs = {84, 118, 42, 118,
  63, 217, 1};

LookupKmapTypeLenAnagram const kmap5_Word_len10_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {10,
  0},
  5,
  kmap5_Word_len10_anagram0_chords,
  kmap5_Word_len10_anagram0_seqs};

c_array_t<ChordData, 8> const kmap5_Word_len10_anagram1_chords = {ChordData {{0, 0, 18}}, ChordData {{2, 0, 0}}, ChordData {{2, 1, 0}}, ChordData {{16, 0, 1}},
  ChordData {{16, 0, 130}}, ChordData {{32, 8, 1}}, ChordData {{32, 8, 64}}, ChordData {{36, 0, 0}}};

c_array_t<uint8_t, 10> const kmap5_Word_len10_anagram1_seqs = {91, 242, 51, 221,
  217, 6, 29, 199,
  73, 109};

LookupKmapTypeLenAnagram const kmap5_Word_len10_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {10,
  1},
  8,
  kmap5_Word_len10_anagram1_chords,
  kmap5_Word_len10_anagram1_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len10_anagram2_chords = {ChordData {{32, 8, 0}}};

c_array_t<uint8_t, 2> const kmap5_Word_len10_anagram2_seqs = {53, 2};

LookupKmapTypeLenAnagram const kmap5_Word_len10_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {10,
  2},
  1,
  kmap5_Word_len10_anagram2_chords,
  kmap5_Word_len10_anagram2_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len10_anagram3_chords = {ChordData {{32, 8, 0}}, ChordData {{34, 8, 0}}};

c_array_t<uint8_t, 3> const kmap5_Word_len10_anagram3_seqs = {177, 114, 3};

LookupKmapTypeLenAnagram const kmap5_Word_len10_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {10,
  3},
  2,
  kmap5_Word_len10_anagram3_chords,
  kmap5_Word_len10_anagram3_seqs};

c_array_t<ChordData, 23> const kmap5_Word_len11_anagram0_chords = {ChordData {{0, 0, 131}}, ChordData {{0, 8, 18}}, ChordData {{0, 65, 0}}, ChordData {{0, 72, 2}},
...
c_array_t<uint8_t, 32> const kmap5_Word_len11_anagram0_seqs = {7, 138, 101, 23,
  128, 232, 195, 179,
  158, 87, 140, 228,
  35, 235, 154, 252,
  247, 232, 95, 223,
...
LookupKmapTypeLenAnagram const kmap5_Word_len11_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {11,
  0},
  23,
  kmap5_Word_len11_anagram0_chords,
  kmap5_Word_len11_anagram0_seqs};

c_array_t<ChordData, 8> const kmap5_Word_len11_anagram1_chords = {ChordData {{16, 0, 9}}, ChordData {{16, 0, 65}}, ChordData {{16, 0, 80}}, ChordData {{16, 4, 1}},
  ChordData {{16, 4, 64}}, ChordData {{20, 0, 0}}, ChordData {{32, 1, 0}}, ChordData {{32, 8, 0}}};

c_array_t<uint8_t, 11> const kmap5_Word_len11_anagram1_seqs = {234, 19, 223, 90,
  254, 44, 254, 102,
  119, 48, 114};

LookupKmapTypeLenAnagram const kmap5_Word_len11_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {11,
  1},
  8,
  kmap5_Word_len11_anagram1_chords,
  kmap5_Word_len11_anagram1_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len11_anagram2_chords = {ChordData {{0, 0, 146}}, ChordData {{16, 0, 65}}, ChordData {{16, 4, 1}}};

c_array_t<uint8_t, 5> const kmap5_Word_len11_anagram2_seqs = {11, 178, 220, 249,
  1};

LookupKmapTypeLenAnagram const kmap5_Word_len11_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {11,
  2},
  3,
  kmap5_Word_len11_anagram2_chords,
  kmap5_Word_len11_anagram2_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len11_anagram3_chords = {ChordData {{16, 4, 16}}, ChordData {{144, 0, 8}}};

c_array_t<uint8_t, 3> const kmap5_Word_len11_anagram3_seqs = {222, 87, 39};

LookupKmapTypeLenAnagram const kmap5_Word_len11_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {11,
  3},
  2,
  kmap5_Word_len11_anagram3_chords,
  kmap5_Word_len11_anagram3_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len11_anagram4_chords = {ChordData {{16, 4, 16}}};

c_array_t<uint8_t, 2> const kmap5_Word_len11_anagram4_seqs = {254, 5};

LookupKmapTypeLenAnagram const kmap5_Word_len11_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {11,
  4},
  1,
  kmap5_Word_len11_anagram4_chords,
  kmap5_Word_len11_anagram4_seqs};

c_array_t<ChordData, 50> const kmap5_Word_len12_anagram0_chords = {ChordData {{0, 0, 81}}, ChordData {{0, 0, 82}}, ChordData {{0, 0, 208}}, ChordData {{0, 4, 3}},
...
c_array_t<uint8_t, 75> const kmap5_Word_len12_anagram0_seqs = {114, 43, 139, 224,
  130, 127, 175, 135,
  175, 247, 187, 175,
  242, 247, 68, 244,
  58, 122, 183, 51,
...
LookupKmapTypeLenAnagram const kmap5_Word_len12_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {12,
  0},
  50,
  kmap5_Word_len12_anagram0_chords,
  kmap5_Word_len12_anagram0_seqs};

c_array_t<ChordData, 21> const kmap5_Word_len12_anagram1_chords = {ChordData {{0, 4, 3}}, ChordData {{0, 4, 9}}, ChordData {{0, 4, 17}}, ChordData {{0, 4, 18}},
...
c_array_t<uint8_t, 32> const kmap5_Word_len12_anagram1_seqs = {143, 167, 127, 191,
  135, 191, 79, 55,
  114, 130, 35, 179,
  157, 29, 125, 204,
  219, 188, 109, 44,
...
LookupKmapTypeLenAnagram const kmap5_Word_len12_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {12,
  1},
  21,
  kmap5_Word_len12_anagram1_chords,
  kmap5_Word_len12_anagram1_seqs};

c_array_t<ChordData, 10> const kmap5_Word_len12_anagram2_chords = {ChordData {{0, 4, 9}}, ChordData {{0, 4, 17}}, ChordData {{0, 4, 65}}, ChordData {{0, 4, 129}},
  ChordData {{2, 0, 9}}, ChordData {{2, 0, 65}}, ChordData {{16, 64, 8}}, ChordData {{48, 1, 64}},
  ChordData {{48, 1, 128}}, ChordData {{128, 0, 8}}};

c_array_t<uint8_t, 15> const kmap5_Word_len12_anagram2_seqs = {247, 186, 127, 114,
  79, 127, 55, 42,
  115, 193, 42, 134,
  208, 164, 169};

LookupKmapTypeLenAnagram const kmap5_Word_len12_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {12,
  2},
  10,
  kmap5_Word_len12_anagram2_chords,
  kmap5_Word_len12_anagram2_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len12_anagram3_chords = {ChordData {{0, 4, 18}}};

c_array_t<uint8_t, 2> const kmap5_Word_len12_anagram3_seqs = {191, 8};

LookupKmapTypeLenAnagram const kmap5_Word_len12_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {12,
  3},
  1,
  kmap5_Word_len12_anagram3_chords,
  kmap5_Word_len12_anagram3_seqs};

c_array_t<ChordData, 71> const kmap5_Word_len13_anagram0_chords = {ChordData {{0, 12, 1}}, ChordData {{0, 12, 2}}, ChordData {{0, 12, 8}}, ChordData {{0, 12, 16}},
...
c_array_t<uint8_t, 116> const kmap5_Word_len13_anagram0_seqs = {241, 47, 62, 198,
  215, 223, 24, 159,
  216, 139, 92, 40,
  116, 132, 225, 53,
  200, 135, 56, 23,
...
LookupKmapTypeLenAnagram const kmap5_Word_len13_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {13,
  0},
  71,
  kmap5_Word_len13_anagram0_chords,
  kmap5_Word_len13_anagram0_seqs};

c_array_t<ChordData, 30> const kmap5_Word_len13_anagram1_chords = {ChordData {{0, 12, 2}}, ChordData {{0, 12, 16}}, ChordData {{0, 32, 64}}, ChordData {{0, 36, 1}},
...
c_array_t<uint8_t, 49> const kmap5_Word_len13_anagram1_seqs = {248, 113, 63, 138,
  48, 246, 135, 31,
  70, 226, 8, 219,
  9, 237, 175, 61,
  182, 95, 249, 214,
...
LookupKmapTypeLenAnagram const kmap5_Word_len13_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {13,
  1},
  30,
  kmap5_Word_len13_anagram1_chords,
  kmap5_Word_len13_anagram1_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len13_anagram2_chords = {ChordData {{0, 12, 64}}, ChordData {{4, 4, 64}}, ChordData {{16, 8, 0}}, ChordData {{48, 9, 0}},
  ChordData {{132, 0, 1}}};

c_array_t<uint8_t, 9> const kmap5_Word_len13_anagram2_seqs = {47, 81, 218, 71,
  71, 232, 152, 237,
  0};

LookupKmapTypeLenAnagram const kmap5_Word_len13_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {13,
  2},
  5,
  kmap5_Word_len13_anagram2_chords,
  kmap5_Word_len13_anagram2_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len13_anagram3_chords = {ChordData {{6, 0, 64}}, ChordData {{128, 64, 2}}};

c_array_t<uint8_t, 4> const kmap5_Word_len13_anagram3_seqs = {50, 13, 51, 0};

LookupKmapTypeLenAnagram const kmap5_Word_len13_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {13,
  3},
  2,
  kmap5_Word_len13_anagram3_chords,
  kmap5_Word_len13_anagram3_seqs};

c_array_t<ChordData, 75> const kmap5_Word_len14_anagram0_chords = {ChordData {{0, 0, 19}}, ChordData {{0, 0, 90}}, ChordData {{0, 4, 26}}, ChordData {{0, 4, 82}},
...
c_array_t<uint8_t, 132> const kmap5_Word_len14_anagram0_seqs = {183, 165, 148, 250,
  90, 202, 151, 244,
  101, 247, 215, 189,
  118, 191, 5, 94,
  129, 194, 62, 126,
...
LookupKmapTypeLenAnagram const kmap5_Word_len14_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  0},
  75,
  kmap5_Word_len14_anagram0_chords,
  kmap5_Word_len14_anagram0_seqs};

c_array_t<ChordData, 28> const kmap5_Word_len14_anagram1_chords = {ChordData {{0, 0, 82}}, ChordData {{0, 68, 0}}, ChordData {{0, 68, 66}}, ChordData {{2, 64, 3}},
...
c_array_t<uint8_t, 49> const kmap5_Word_len14_anagram1_seqs = {82, 74, 248, 32,
  15, 0, 115, 97,
  226, 183, 246, 177,
  177, 105, 183, 246,
  25, 180, 54, 137,
...
LookupKmapTypeLenAnagram const kmap5_Word_len14_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  1},
  28,
  kmap5_Word_len14_anagram1_chords,
  kmap5_Word_len14_anagram1_seqs};

c_array_t<ChordData, 12> const kmap5_Word_len14_anagram2_chords = {ChordData {{0, 0, 18}}, ChordData {{0, 68, 18}}, ChordData {{16, 0, 9}}, ChordData {{16, 0, 129}},
...
c_array_t<uint8_t, 21> const kmap5_Word_len14_anagram2_seqs = {184, 229, 62, 112,
  182, 158, 201, 157,
  3, 172, 26, 171,
  116, 153, 45, 27,
  204, 208, 231, 109,
...
LookupKmapTypeLenAnagram const kmap5_Word_len14_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  2},
  12,
  kmap5_Word_len14_anagram2_chords,
  kmap5_Word_len14_anagram2_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len14_anagram3_chords = {ChordData {{32, 1, 8}}, ChordData {{32, 13, 0}}, ChordData {{34, 1, 0}}, ChordData {{128, 64, 10}},
  ChordData {{164, 0, 16}}};

c_array_t<uint8_t, 9> const kmap5_Word_len14_anagram3_seqs = {80, 107, 124, 8,
  7, 2, 169, 125,
  46};

LookupKmapTypeLenAnagram const kmap5_Word_len14_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  3},
  5,
  kmap5_Word_len14_anagram3_chords,
  kmap5_Word_len14_anagram3_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len14_anagram4_chords = {ChordData {{0, 4, 18}}, ChordData {{128, 64, 2}}, ChordData {{164, 0, 16}}};

c_array_t<uint8_t, 6> const kmap5_Word_len14_anagram4_seqs = {251, 37, 38, 208,
  111, 2};

LookupKmapTypeLenAnagram const kmap5_Word_len14_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  4},
  3,
  kmap5_Word_len14_anagram4_chords,
  kmap5_Word_len14_anagram4_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len14_anagram7_chords = {ChordData {{0, 68, 18}}};

c_array_t<uint8_t, 2> const kmap5_Word_len14_anagram7_seqs = {192, 47};

LookupKmapTypeLenAnagram const kmap5_Word_len14_anagram7 = LookupKmapTypeLenAnagram {LengthAndAnagram {14,
  7},
  1,
  kmap5_Word_len14_anagram7_chords,
  kmap5_Word_len14_anagram7_seqs};

c_array_t<ChordData, 77> const kmap5_Word_len15_anagram0_chords = {ChordData {{0, 4, 131}}, ChordData {{0, 8, 82}}, ChordData {{0, 8, 146}}, ChordData {{0, 9, 1}},
...
c_array_t<uint8_t, 145> const kmap5_Word_len15_anagram0_seqs = {247, 32, 41, 99,
  25, 169, 187, 24,
  191, 124, 41, 134,
  45, 67, 41, 5,
  6, 25, 80, 113,
...
LookupKmapTypeLenAnagram const kmap5_Word_len15_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {15,
  0},
  77,
  kmap5_Word_len15_anagram0_chords,
  kmap5_Word_len15_anagram0_seqs};

c_array_t<ChordData, 33> const kmap5_Word_len15_anagram1_chords = {ChordData {{0, 9, 1}}, ChordData {{0, 13, 2}}, ChordData {{0, 68, 18}}, ChordData {{0, 69, 0}},
...
c_array_t<uint8_t, 62> const kmap5_Word_len15_anagram1_seqs = {241, 186, 199, 98,
  248, 178, 251, 208,
  88, 139, 45, 172,
  241, 206, 68, 224,
  62, 178, 200, 175,
...
LookupKmapTypeLenAnagram const kmap5_Word_len15_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {15,
  1},
  33,
  kmap5_Word_len15_anagram1_chords,
  kmap5_Word_len15_anagram1_seqs};

c_array_t<ChordData, 22> const kmap5_Word_len15_anagram2_chords = {ChordData {{0, 36, 18}}, ChordData {{2, 9, 64}}, ChordData {{16, 0, 25}}, ChordData {{16, 0, 72}},
...
c_array_t<uint8_t, 42> const kmap5_Word_len15_anagram2_seqs = {236, 75, 41, 206,
  121, 85, 45, 162,
  150, 19, 19, 237,
  175, 207, 191, 251,
  104, 191, 220, 49,
...
LookupKmapTypeLenAnagram const kmap5_Word_len15_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {15,
  2},
  22,
  kmap5_Word_len15_anagram2_chords,
  kmap5_Word_len15_anagram2_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len15_anagram3_chords = {ChordData {{16, 0, 9}}};

c_array_t<uint8_t, 2> const kmap5_Word_len15_anagram3_seqs = {103, 61};

LookupKmapTypeLenAnagram const kmap5_Word_len15_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {15,
  3},
  1,
  kmap5_Word_len15_anagram3_chords,
  kmap5_Word_len15_anagram3_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len15_anagram5_chords = {ChordData {{16, 4, 16}}};

c_array_t<uint8_t, 2> const kmap5_Word_len15_anagram5_seqs = {235, 95};

LookupKmapTypeLenAnagram const kmap5_Word_len15_anagram5 = LookupKmapTypeLenAnagram {LengthAndAnagram {15,
  5},
  1,
  kmap5_Word_len15_anagram5_chords,
  kmap5_Word_len15_anagram5_seqs};

c_array_t<ChordData, 140> const kmap5_Word_len16_anagram0_chords = {ChordData {{0, 0, 147}}, ChordData {{0, 1, 18}}, ChordData {{0, 1, 146}}, ChordData {{0, 4, 19}},
...
c_array_t<uint8_t, 280> const kmap5_Word_len16_anagram0_seqs = {120, 75, 221, 150,
  29, 149, 248, 123,
  248, 114, 130, 175,
  247, 68, 248, 68,
  224, 191, 244, 114,
...
LookupKmapTypeLenAnagram const kmap5_Word_len16_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {16,
  0},
  140,
  kmap5_Word_len16_anagram0_chords,
  kmap5_Word_len16_anagram0_seqs};

c_array_t<ChordData, 42> const kmap5_Word_len16_anagram1_chords = {ChordData {{0, 4, 65}}, ChordData {{0, 4, 81}}, ChordData {{0, 4, 130}}, ChordData {{0, 4, 193}},
...
c_array_t<uint8_t, 84> const kmap5_Word_len16_anagram1_seqs = {114, 127, 114, 191,
  248, 132, 242, 116,
  163, 115, 55, 116,
  55, 79, 242, 67,
  109, 64, 209, 34,
...
LookupKmapTypeLenAnagram const kmap5_Word_len16_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {16,
  1},
  42,
  kmap5_Word_len16_anagram1_chords,
  kmap5_Word_len16_anagram1_seqs};

c_array_t<ChordData, 16> const kmap5_Word_len16_anagram2_chords = {ChordData {{0, 4, 3}}, ChordData {{2, 0, 193}}, ChordData {{16, 12, 1}}, ChordData {{16, 68, 16}},
...
c_array_t<uint8_t, 32> const kmap5_Word_len16_anagram2_seqs = {247, 120, 66, 115,
  209, 127, 225, 215,
  55, 193, 97, 208,
  237, 209, 173, 246,
  253, 151, 86, 168,
...
LookupKmapTypeLenAnagram const kmap5_Word_len16_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {16,
  2},
  16,
  kmap5_Word_len16_anagram2_chords,
  kmap5_Word_len16_anagram2_seqs};

c_array_t<ChordData, 4> const kmap5_Word_len16_anagram3_chords = {ChordData {{16, 8, 0}}, ChordData {{16, 12, 1}}, ChordData {{20, 4, 16}}, ChordData {{128, 0, 8}}};

c_array_t<uint8_t, 8> const kmap5_Word_len16_anagram3_seqs = {209, 209, 209, 247,
  235, 111, 154, 169};

LookupKmapTypeLenAnagram const kmap5_Word_len16_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {16,
  3},
  4,
  kmap5_Word_len16_anagram3_chords,
  kmap5_Word_len16_anagram3_seqs};

c_array_t<ChordData, 173> const kmap5_Word_len17_anagram0_chords = {ChordData {{0, 5, 130}}, ChordData {{0, 9, 82}}, ChordData {{0, 12, 17}}, ChordData {{0, 12, 64}},
...
c_array_t<uint8_t, 368> const kmap5_Word_len17_anagram0_seqs = {221, 131, 164, 88,
  198, 223, 139, 47,
  18, 127, 229, 216,
  31, 178, 191, 99,
  175, 200, 94, 145,
...
LookupKmapTypeLenAnagram const kmap5_Word_len17_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {17,
  0},
  173,
  kmap5_Word_len17_anagram0_chords,
  kmap5_Word_len17_anagram0_seqs};

c_array_t<ChordData, 65> const kmap5_Word_len17_anagram1_chords = {ChordData {{0, 12, 130}}, ChordData {{0, 12, 144}}, ChordData {{0, 36, 18}}, ChordData {{2, 8, 8}},
...
c_array_t<uint8_t, 139> const kmap5_Word_len17_anagram1_seqs = {248, 20, 193, 63,
  254, 34, 139, 163,
  35, 55, 113, 226,
  211, 177, 81, 97,
  115, 108, 136, 194,
...
LookupKmapTypeLenAnagram const kmap5_Word_len17_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {17,
  1},
  65,
  kmap5_Word_len17_anagram1_chords,
  kmap5_Word_len17_anagram1_seqs};

c_array_t<ChordData, 18> const kmap5_Word_len17_anagram2_chords = {ChordData {{0, 12, 130}}, ChordData {{0, 68, 130}}, ChordData {{2, 32, 65}}, ChordData {{4, 4, 17}},
...
c_array_t<uint8_t, 39> const kmap5_Word_len17_anagram2_seqs = {72, 31, 129, 7,
  177, 145, 187, 253,
  214, 70, 196, 32,
  35, 96, 7, 224,
  215, 224, 3, 251,
...
LookupKmapTypeLenAnagram const kmap5_Word_len17_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {17,
  2},
  18,
  kmap5_Word_len17_anagram2_chords,
  kmap5_Word_len17_anagram2_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len17_anagram3_chords = {ChordData {{16, 68, 18}}, ChordData {{20, 0, 16}}, ChordData {{128, 64, 18}}};

c_array_t<uint8_t, 7> const kmap5_Word_len17_anagram3_seqs = {128, 127, 219, 186,
  97, 110, 0};

LookupKmapTypeLenAnagram const kmap5_Word_len17_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {17,
  3},
  3,
  kmap5_Word_len17_anagram3_chords,
  kmap5_Word_len17_anagram3_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len17_anagram5_chords = {ChordData {{0, 68, 18}}};

c_array_t<uint8_t, 3> const kmap5_Word_len17_anagram5_seqs = {248, 27, 0};

LookupKmapTypeLenAnagram const kmap5_Word_len17_anagram5 = LookupKmapTypeLenAnagram {LengthAndAnagram {17,
  5},
  1,
  kmap5_Word_len17_anagram5_chords,
  kmap5_Word_len17_anagram5_seqs};

c_array_t<ChordData, 147> const kmap5_Word_len18_anagram0_chords = {ChordData {{0, 4, 83}}, ChordData {{0, 5, 3}}, ChordData {{0, 5, 65}}, ChordData {{0, 5, 128}},
...
c_array_t<uint8_t, 331> const kmap5_Word_len18_anagram0_seqs = {114, 95, 118, 143,
  215, 189, 92, 247,
  68, 29, 253, 105,
  129, 199, 46, 82,
  252, 99, 236, 55,
...
LookupKmapTypeLenAnagram const kmap5_Word_len18_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {18,
  0},
  147,
  kmap5_Word_len18_anagram0_chords,
  kmap5_Word_len18_anagram0_seqs};

c_array_t<ChordData, 40> const kmap5_Word_len18_anagram1_chords = {ChordData {{0, 0, 90}}, ChordData {{0, 4, 26}}, ChordData {{0, 4, 146}}, ChordData {{0, 5, 130}},
...
c_array_t<uint8_t, 90> const kmap5_Word_len18_anagram1_seqs = {82, 42, 150, 191,
  250, 68, 37, 62,
  117, 5, 18, 177,
  23, 6, 60, 17,
  206, 149, 251, 177,
...
LookupKmapTypeLenAnagram const kmap5_Word_len18_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {18,
  1},
  40,
  kmap5_Word_len18_anagram1_chords,
  kmap5_Word_len18_anagram1_seqs};

c_array_t<ChordData, 15> const kmap5_Word_len18_anagram2_chords = {ChordData {{0, 4, 19}}, ChordData {{0, 4, 146}}, ChordData {{0, 64, 2}}, ChordData {{4, 12, 0}},
...
c_array_t<uint8_t, 34> const kmap5_Word_len18_anagram2_seqs = {183, 95, 34, 125,
  9, 0, 64, 193,
  111, 38, 227, 145,
  95, 220, 125, 52,
  96, 10, 177, 222,
...
LookupKmapTypeLenAnagram const kmap5_Word_len18_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {18,
  2},
  15,
  kmap5_Word_len18_anagram2_chords,
  kmap5_Word_len18_anagram2_seqs};

c_array_t<ChordData, 6> const kmap5_Word_len18_anagram3_chords = {ChordData {{0, 4, 146}}, ChordData {{16, 0, 81}}, ChordData {{16, 13, 128}}, ChordData {{18, 0, 129}},
  ChordData {{48, 1, 128}}, ChordData {{48, 9, 0}}};

c_array_t<uint8_t, 14> const kmap5_Word_len18_anagram3_seqs = {224, 95, 202, 217,
  75, 95, 180, 105,
  206, 93, 53, 65,
  187, 8};

LookupKmapTypeLenAnagram const kmap5_Word_len18_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {18,
  3},
  6,
  kmap5_Word_len18_anagram3_chords,
  kmap5_Word_len18_anagram3_seqs};

c_array_t<ChordData, 140> const kmap5_Word_len19_anagram0_chords = {ChordData {{0, 12, 26}}, ChordData {{0, 12, 146}}, ChordData {{0, 13, 9}}, ChordData {{0, 13, 10}},
...
c_array_t<uint8_t, 333> const kmap5_Word_len19_anagram0_seqs = {241, 181, 44, 63,
  210, 189, 22, 245,
  177, 184, 143, 197,
  125, 45, 222, 75,
  81, 30, 139, 247,
...
LookupKmapTypeLenAnagram const kmap5_Word_len19_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {19,
  0},
  140,
  kmap5_Word_len19_anagram0_chords,
  kmap5_Word_len19_anagram0_seqs};

c_array_t<ChordData, 57> const kmap5_Word_len19_anagram1_chords = {ChordData {{0, 12, 64}}, ChordData {{0, 13, 3}}, ChordData {{0, 13, 16}}, ChordData {{0, 68, 10}},
...
c_array_t<uint8_t, 136> const kmap5_Word_len19_anagram1_seqs = {188, 124, 188, 199,
  98, 247, 27, 195,
  3, 122, 15, 154,
  226, 136, 72, 113,
  180, 27, 138, 50,
...
LookupKmapTypeLenAnagram const kmap5_Word_len19_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {19,
  1},
  57,
  kmap5_Word_len19_anagram1_chords,
  kmap5_Word_len19_anagram1_seqs};

c_array_t<ChordData, 14> const kmap5_Word_len19_anagram2_chords = {ChordData {{4, 4, 18}}, ChordData {{16, 4, 19}}, ChordData {{16, 4, 24}}, ChordData {{16, 4, 146}},
...
c_array_t<uint8_t, 34> const kmap5_Word_len19_anagram2_seqs = {109, 191, 188, 125,
  244, 175, 245, 145,
  252, 123, 108, 109,
  88, 183, 78, 172,
  177, 175, 68, 152,
...
LookupKmapTypeLenAnagram const kmap5_Word_len19_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {19,
  2},
  14,
  kmap5_Word_len19_anagram2_chords,
  kmap5_Word_len19_anagram2_seqs};

c_array_t<ChordData, 7> const kmap5_Word_len19_anagram3_chords = {ChordData {{0, 68, 18}}, ChordData {{16, 4, 19}}, ChordData {{16, 4, 65}}, ChordData {{16, 4, 138}},
  ChordData {{48, 1, 24}}, ChordData {{52, 8, 16}}, ChordData {{160, 1, 128}}};

c_array_t<uint8_t, 17> const kmap5_Word_len19_anagram3_seqs = {97, 31, 192, 63,
  239, 189, 156, 233,
  21, 13, 173, 94,
  206, 219, 195, 164,
  14};

LookupKmapTypeLenAnagram const kmap5_Word_len19_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {19,
  3},
  7,
  kmap5_Word_len19_anagram3_chords,
  kmap5_Word_len19_anagram3_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len19_anagram4_chords = {ChordData {{0, 68, 18}}, ChordData {{16, 4, 145}}};

c_array_t<uint8_t, 5> const kmap5_Word_len19_anagram4_seqs = {192, 111, 120, 242,
  30};

LookupKmapTypeLenAnagram const kmap5_Word_len19_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {19,
  4},
  2,
  kmap5_Word_len19_anagram4_chords,
  kmap5_Word_len19_anagram4_seqs};

c_array_t<ChordData, 155> const kmap5_Word_len20_anagram0_chords = {ChordData {{0, 4, 81}}, ChordData {{0, 4, 89}}, ChordData {{0, 4, 138}}, ChordData {{0, 4, 194}},
...
c_array_t<uint8_t, 388> const kmap5_Word_len20_anagram0_seqs = {114, 191, 119, 251,
  42, 248, 250, 132,
  244, 34, 250, 242,
  20, 127, 139, 236,
  177, 168, 210, 1,
...
LookupKmapTypeLenAnagram const kmap5_Word_len20_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {20,
  0},
  155,
  kmap5_Word_len20_anagram0_chords,
  kmap5_Word_len20_anagram0_seqs};

c_array_t<ChordData, 47> const kmap5_Word_len20_anagram1_chords = {ChordData {{0, 4, 19}}, ChordData {{0, 13, 64}}, ChordData {{0, 40, 19}}, ChordData {{2, 0, 193}},
...
c_array_t<uint8_t, 118> const kmap5_Word_len20_anagram1_seqs = {183, 143, 23, 95,
  138, 177, 60, 38,
  55, 68, 130, 67,
  115, 115, 175, 183,
  63, 42, 247, 163,
...
LookupKmapTypeLenAnagram const kmap5_Word_len20_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {20,
  1},
  47,
  kmap5_Word_len20_anagram1_chords,
  kmap5_Word_len20_anagram1_seqs};

c_array_t<ChordData, 17> const kmap5_Word_len20_anagram2_chords = {ChordData {{0, 4, 193}}, ChordData {{2, 9, 128}}, ChordData {{16, 1, 16}}, ChordData {{16, 1, 129}},
...
c_array_t<uint8_t, 43> const kmap5_Word_len20_anagram2_seqs = {114, 79, 20, 135,
  138, 235, 206, 219,
  145, 125, 199, 124,
  143, 143, 204, 254,
  61, 118, 128, 125,
...
LookupKmapTypeLenAnagram const kmap5_Word_len20_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {20,
  2},
  17,
  kmap5_Word_len20_anagram2_chords,
  kmap5_Word_len20_anagram2_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len20_anagram3_chords = {ChordData {{16, 36, 17}}, ChordData {{32, 1, 128}}};

c_array_t<uint8_t, 5> const kmap5_Word_len20_anagram3_seqs = {204, 191, 7, 43,
  117};

LookupKmapTypeLenAnagram const kmap5_Word_len20_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {20,
  3},
  2,
  kmap5_Word_len20_anagram3_chords,
  kmap5_Word_len20_anagram3_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len20_anagram6_chords = {ChordData {{48, 8, 80}}};

c_array_t<uint8_t, 3> const kmap5_Word_len20_anagram6_seqs = {156, 87, 12};

LookupKmapTypeLenAnagram const kmap5_Word_len20_anagram6 = LookupKmapTypeLenAnagram {LengthAndAnagram {20,
  6},
  1,
  kmap5_Word_len20_anagram6_chords,
  kmap5_Word_len20_anagram6_seqs};

c_array_t<ChordData, 171> const kmap5_Word_len21_anagram0_chords = {ChordData {{0, 12, 81}}, ChordData {{0, 12, 144}}, ChordData {{0, 12, 192}}, ChordData {{0, 36, 19}},
...
c_array_t<uint8_t, 449> const kmap5_Word_len21_anagram0_seqs = {18, 127, 239, 233,
  55, 74, 124, 34,
  100, 191, 183, 175,
  200, 110, 95, 24,
  238, 11, 19, 246,
...
LookupKmapTypeLenAnagram const kmap5_Word_len21_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {21,
  0},
  171,
  kmap5_Word_len21_anagram0_chords,
  kmap5_Word_len21_anagram0_seqs};

c_array_t<ChordData, 44> const kmap5_Word_len21_anagram1_chords = {ChordData {{0, 36, 3}}, ChordData {{0, 36, 192}}, ChordData {{2, 12, 8}}, ChordData {{2, 64, 0}},
...
c_array_t<uint8_t, 116> const kmap5_Word_len21_anagram1_seqs = {248, 135, 76, 232,
  133, 197, 215, 121,
  126, 248, 16, 166,
  235, 190, 253, 94,
  123, 185, 23, 220,
...
LookupKmapTypeLenAnagram const kmap5_Word_len21_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {21,
  1},
  44,
  kmap5_Word_len21_anagram1_chords,
  kmap5_Word_len21_anagram1_seqs};

c_array_t<ChordData, 12> const kmap5_Word_len21_anagram2_chords = {ChordData {{0, 12, 18}}, ChordData {{6, 0, 192}}, ChordData {{36, 0, 18}}, ChordData {{48, 8, 24}},
...
c_array_t<uint8_t, 32> const kmap5_Word_len21_anagram2_seqs = {252, 199, 82, 218,
  16, 109, 237, 75,
  173, 209, 203, 121,
  161, 91, 93, 113,
  151, 91, 20, 150,
...
LookupKmapTypeLenAnagram const kmap5_Word_len21_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {21,
  2},
  12,
  kmap5_Word_len21_anagram2_chords,
  kmap5_Word_len21_anagram2_seqs};

c_array_t<ChordData, 4> const kmap5_Word_len21_anagram3_chords = {ChordData {{16, 0, 130}}, ChordData {{16, 4, 82}}, ChordData {{48, 8, 8}}, ChordData {{176, 1, 16}}};

c_array_t<uint8_t, 11> const kmap5_Word_len21_anagram3_seqs = {6, 161, 201, 34,
  95, 114, 214, 234,
  77, 88, 13};

LookupKmapTypeLenAnagram const kmap5_Word_len21_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {21,
  3},
  4,
  kmap5_Word_len21_anagram3_chords,
  kmap5_Word_len21_anagram3_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len21_anagram4_chords = {ChordData {{16, 4, 146}}, ChordData {{176, 1, 16}}};

c_array_t<uint8_t, 6> const kmap5_Word_len21_anagram4_seqs = {107, 250, 114, 179,
  66, 3};

LookupKmapTypeLenAnagram const kmap5_Word_len21_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {21,
  4},
  2,
  kmap5_Word_len21_anagram4_chords,
  kmap5_Word_len21_anagram4_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len21_anagram5_chords = {ChordData {{16, 68, 18}}, ChordData {{128, 64, 2}}, ChordData {{128, 64, 18}}};

c_array_t<uint8_t, 8> const kmap5_Word_len21_anagram5_seqs = {15, 252, 154, 15,
  9, 96, 230, 6};

LookupKmapTypeLenAnagram const kmap5_Word_len21_anagram5 = LookupKmapTypeLenAnagram {LengthAndAnagram {21,
  5},
  3,
  kmap5_Word_len21_anagram5_chords,
  kmap5_Word_len21_anagram5_seqs};

c_array_t<ChordData, 191> const kmap5_Word_len22_anagram0_chords = {ChordData {{0, 1, 16}}, ChordData {{0, 4, 18}}, ChordData {{0, 4, 80}}, ChordData {{0, 4, 91}},
...
c_array_t<uint8_t, 526> const kmap5_Word_len22_anagram0_seqs = {252, 242, 221, 239,
  126, 201, 203, 239,
  235, 203, 149, 184,
  223, 93, 252, 67,
  22, 127, 145, 197,
...
LookupKmapTypeLenAnagram const kmap5_Word_len22_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {22,
  0},
  191,
  kmap5_Word_len22_anagram0_chords,
  kmap5_Word_len22_anagram0_seqs};

c_array_t<ChordData, 44> const kmap5_Word_len22_anagram1_chords = {ChordData {{0, 4, 82}}, ChordData {{0, 5, 129}}, ChordData {{0, 44, 18}}, ChordData {{0, 109, 2}},
...
c_array_t<uint8_t, 121> const kmap5_Word_len22_anagram1_seqs = {130, 191, 101, 247,
  247, 132, 236, 55,
  178, 7, 138, 84,
  238, 32, 223, 248,
  40, 198, 245, 209,
...
LookupKmapTypeLenAnagram const kmap5_Word_len22_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {22,
  1},
  44,
  kmap5_Word_len22_anagram1_chords,
  kmap5_Word_len22_anagram1_seqs};

c_array_t<ChordData, 12> const kmap5_Word_len22_anagram2_chords = {ChordData {{0, 4, 18}}, ChordData {{6, 0, 1}}, ChordData {{16, 0, 27}}, ChordData {{16, 0, 81}},
...
c_array_t<uint8_t, 33> const kmap5_Word_len22_anagram2_seqs = {248, 187, 101, 155,
  54, 135, 214, 243,
  202, 173, 125, 184,
  126, 241, 171, 26,
  212, 209, 71, 91,
...
LookupKmapTypeLenAnagram const kmap5_Word_len22_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {22,
  2},
  12,
  kmap5_Word_len22_anagram2_chords,
  kmap5_Word_len22_anagram2_seqs};

c_array_t<ChordData, 4> const kmap5_Word_len22_anagram3_chords = {ChordData {{16, 4, 18}}, ChordData {{16, 4, 145}}, ChordData {{16, 4, 146}}, ChordData {{36, 1, 0}}};

c_array_t<uint8_t, 11> const kmap5_Word_len22_anagram3_seqs = {248, 107, 239, 154,
  254, 188, 166, 7,
  181, 218, 117};

LookupKmapTypeLenAnagram const kmap5_Word_len22_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {22,
  3},
  4,
  kmap5_Word_len22_anagram3_chords,
  kmap5_Word_len22_anagram3_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len22_anagram4_chords = {ChordData {{16, 4, 65}}, ChordData {{48, 9, 16}}};

c_array_t<uint8_t, 6> const kmap5_Word_len22_anagram4_seqs = {150, 251, 115, 103,
  206, 11};

LookupKmapTypeLenAnagram const kmap5_Word_len22_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {22,
  4},
  2,
  kmap5_Word_len22_anagram4_chords,
  kmap5_Word_len22_anagram4_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len22_anagram6_chords = {ChordData {{16, 68, 18}}};

c_array_t<uint8_t, 3> const kmap5_Word_len22_anagram6_seqs = {193, 248, 37};

LookupKmapTypeLenAnagram const kmap5_Word_len22_anagram6 = LookupKmapTypeLenAnagram {LengthAndAnagram {22,
  6},
  1,
  kmap5_Word_len22_anagram6_chords,
  kmap5_Word_len22_anagram6_seqs};

c_array_t<ChordData, 162> const kmap5_Word_len23_anagram0_chords = {ChordData {{0, 13, 19}}, ChordData {{0, 13, 26}}, ChordData {{0, 13, 67}}, ChordData {{0, 13, 146}},
...
c_array_t<uint8_t, 466> const kmap5_Word_len23_anagram0_seqs = {183, 143, 69, 220,
  215, 162, 220, 99,
  17, 252, 177, 40,
  244, 88, 148, 82,
  143, 9, 251, 238,
...
LookupKmapTypeLenAnagram const kmap5_Word_len23_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {23,
  0},
  162,
  kmap5_Word_len23_anagram0_chords,
  kmap5_Word_len23_anagram0_seqs};

c_array_t<ChordData, 52> const kmap5_Word_len23_anagram1_chords = {ChordData {{0, 12, 1}}, ChordData {{0, 12, 18}}, ChordData {{0, 13, 18}}, ChordData {{0, 36, 19}},
...
c_array_t<uint8_t, 150> const kmap5_Word_len23_anagram1_seqs = {124, 252, 59, 62,
  254, 34, 238, 99,
  177, 124, 100, 135,
  175, 161, 4, 254,
  144, 133, 159, 45,
...
LookupKmapTypeLenAnagram const kmap5_Word_len23_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {23,
  1},
  52,
  kmap5_Word_len23_anagram1_chords,
  kmap5_Word_len23_anagram1_seqs};

c_array_t<ChordData, 20> const kmap5_Word_len23_anagram2_chords = {ChordData {{0, 68, 26}}, ChordData {{2, 68, 18}}, ChordData {{2, 96, 3}}, ChordData {{4, 4, 82}},
...
c_array_t<uint8_t, 58> const kmap5_Word_len23_anagram2_seqs = {251, 26, 202, 48,
  191, 37, 48, 135,
  76, 218, 126, 249,
  187, 150, 195, 191,
  35, 211, 223, 121,
...
LookupKmapTypeLenAnagram const kmap5_Word_len23_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {23,
  2},
  20,
  kmap5_Word_len23_anagram2_chords,
  kmap5_Word_len23_anagram2_seqs};

c_array_t<ChordData, 6> const kmap5_Word_len23_anagram3_chords = {ChordData {{20, 0, 19}}, ChordData {{32, 69, 16}}, ChordData {{48, 1, 16}}, ChordData {{48, 9, 16}},
  ChordData {{48, 12, 128}}, ChordData {{128, 12, 18}}};

c_array_t<uint8_t, 18> const kmap5_Word_len23_anagram3_seqs = {107, 116, 59, 88,
  127, 3, 15, 215,
  208, 209, 11, 205,
  61, 113, 142, 95,
  230, 2};

LookupKmapTypeLenAnagram const kmap5_Word_len23_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {23,
  3},
  6,
  kmap5_Word_len23_anagram3_chords,
  kmap5_Word_len23_anagram3_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len23_anagram4_chords = {ChordData {{128, 64, 18}}, ChordData {{160, 33, 1}}};

c_array_t<uint8_t, 6> const kmap5_Word_len23_anagram4_seqs = {184, 9, 132, 203,
  10, 25};

LookupKmapTypeLenAnagram const kmap5_Word_len23_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {23,
  4},
  2,
  kmap5_Word_len23_anagram4_chords,
  kmap5_Word_len23_anagram4_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len23_anagram5_chords = {ChordData {{16, 4, 146}}};

c_array_t<uint8_t, 3> const kmap5_Word_len23_anagram5_seqs = {124, 249, 100};

LookupKmapTypeLenAnagram const kmap5_Word_len23_anagram5 = LookupKmapTypeLenAnagram {LengthAndAnagram {23,
  5},
  1,
  kmap5_Word_len23_anagram5_chords,
  kmap5_Word_len23_anagram5_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len23_anagram6_chords = {ChordData {{0, 68, 18}}};

c_array_t<uint8_t, 3> const kmap5_Word_len23_anagram6_seqs = {15, 252, 6};

LookupKmapTypeLenAnagram const kmap5_Word_len23_anagram6 = LookupKmapTypeLenAnagram {LengthAndAnagram {23,
  6},
  1,
  kmap5_Word_len23_anagram6_chords,
  kmap5_Word_len23_anagram6_seqs};

c_array_t<ChordData, 164> const kmap5_Word_len24_anagram0_chords = {ChordData {{0, 5, 26}}, ChordData {{0, 45, 9}}, ChordData {{0, 45, 80}}, ChordData {{0, 68, 3}},
...
c_array_t<uint8_t, 492> const kmap5_Word_len24_anagram0_seqs = {221, 43, 150, 199,
  94, 139, 194, 126,
  139, 60, 240, 119,
  184, 35, 35, 114,
  59, 120, 72, 163,
...
LookupKmapTypeLenAnagram const kmap5_Word_len24_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {24,
  0},
  164,
  kmap5_Word_len24_anagram0_chords,
  kmap5_Word_len24_anagram0_seqs};

c_array_t<ChordData, 36> const kmap5_Word_len24_anagram1_chords = {ChordData {{0, 5, 65}}, ChordData {{2, 1, 130}}, ChordData {{2, 4, 81}}, ChordData {{2, 4, 89}},
...
c_array_t<uint8_t, 108> const kmap5_Word_len24_anagram1_seqs = {114, 223, 117, 72,
  211, 117, 191, 55,
  114, 114, 251, 163,
  251, 56, 79, 192,
  132, 99, 223, 26,
...
LookupKmapTypeLenAnagram const kmap5_Word_len24_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {24,
  1},
  36,
  kmap5_Word_len24_anagram1_chords,
  kmap5_Word_len24_anagram1_seqs};

c_array_t<ChordData, 8> const kmap5_Word_len24_anagram2_chords = {ChordData {{2, 0, 19}}, ChordData {{18, 64, 19}}, ChordData {{20, 4, 130}}, ChordData {{22, 0, 81}},
  ChordData {{48, 5, 17}}, ChordData {{128, 4, 146}}, ChordData {{128, 64, 18}}, ChordData {{144, 64, 2}}};

c_array_t<uint8_t, 24> const kmap5_Word_len24_anagram2_seqs = {184, 115, 131, 97,
  214, 120, 237, 233,
  209, 109, 199, 114,
  247, 11, 125, 152,
  68, 191, 64, 238,
...
LookupKmapTypeLenAnagram const kmap5_Word_len24_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {24,
  2},
  8,
  kmap5_Word_len24_anagram2_chords,
  kmap5_Word_len24_anagram2_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len24_anagram3_chords = {ChordData {{22, 8, 16}}, ChordData {{48, 8, 80}}};

c_array_t<uint8_t, 6> const kmap5_Word_len24_anagram3_seqs = {142, 109, 214, 107,
  169, 209};

LookupKmapTypeLenAnagram const kmap5_Word_len24_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {24,
  3},
  2,
  kmap5_Word_len24_anagram3_chords,
  kmap5_Word_len24_anagram3_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len24_anagram4_chords = {ChordData {{16, 68, 18}}, ChordData {{16, 68, 146}}};

c_array_t<uint8_t, 6> const kmap5_Word_len24_anagram4_seqs = {191, 248, 193, 184,
  31, 200};

LookupKmapTypeLenAnagram const kmap5_Word_len24_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {24,
  4},
  2,
  kmap5_Word_len24_anagram4_chords,
  kmap5_Word_len24_anagram4_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len24_anagram5_chords = {ChordData {{48, 8, 80}}};

c_array_t<uint8_t, 3> const kmap5_Word_len24_anagram5_seqs = {226, 229, 188};

LookupKmapTypeLenAnagram const kmap5_Word_len24_anagram5 = LookupKmapTypeLenAnagram {LengthAndAnagram {24,
  5},
  1,
  kmap5_Word_len24_anagram5_chords,
  kmap5_Word_len24_anagram5_seqs};

c_array_t<ChordData, 179> const kmap5_Word_len25_anagram0_chords = {ChordData {{0, 36, 80}}, ChordData {{2, 9, 18}}, ChordData {{2, 12, 136}}, ChordData {{2, 40, 128}},
...
c_array_t<uint8_t, 560> const kmap5_Word_len25_anagram0_seqs = {236, 247, 69, 248,
  29, 44, 190, 78,
  124, 226, 167, 192,
  184, 31, 230, 41,
  140, 220, 211, 8,
...
LookupKmapTypeLenAnagram const kmap5_Word_len25_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {25,
  0},
  179,
  kmap5_Word_len25_anagram0_chords,
  kmap5_Word_len25_anagram0_seqs};

c_array_t<ChordData, 38> const kmap5_Word_len25_anagram1_chords = {ChordData {{0, 68, 89}}, ChordData {{6, 0, 81}}, ChordData {{16, 0, 74}}, ChordData {{16, 13, 128}},
...
c_array_t<uint8_t, 119> const kmap5_Word_len25_anagram1_seqs = {114, 251, 26, 164,
  205, 206, 89, 196,
  138, 238, 28, 159,
  108, 16, 218, 97,
  180, 51, 222, 58,
...
LookupKmapTypeLenAnagram const kmap5_Word_len25_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {25,
  1},
  38,
  kmap5_Word_len25_anagram1_chords,
  kmap5_Word_len25_anagram1_seqs};

c_array_t<ChordData, 8> const kmap5_Word_len25_anagram2_chords = {ChordData {{0, 36, 3}}, ChordData {{16, 0, 139}}, ChordData {{16, 4, 136}}, ChordData {{16, 4, 152}},
  ChordData {{18, 64, 27}}, ChordData {{20, 4, 128}}, ChordData {{52, 4, 129}}, ChordData {{148, 0, 64}}};

c_array_t<uint8_t, 25> const kmap5_Word_len25_anagram2_seqs = {127, 247, 200, 12,
  58, 235, 241, 79,
  100, 229, 193, 95,
  13, 140, 158, 247,
  91, 243, 83, 255,
...
LookupKmapTypeLenAnagram const kmap5_Word_len25_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {25,
  2},
  8,
  kmap5_Word_len25_anagram2_chords,
  kmap5_Word_len25_anagram2_seqs};

c_array_t<ChordData, 4> const kmap5_Word_len25_anagram3_chords = {ChordData {{0, 12, 18}}, ChordData {{48, 1, 17}}, ChordData {{48, 5, 16}}, ChordData {{160, 65, 0}}};

c_array_t<uint8_t, 13> const kmap5_Word_len25_anagram3_seqs = {124, 252, 45, 215,
  93, 61, 195, 223,
  135, 230, 67, 86,
  8};

LookupKmapTypeLenAnagram const kmap5_Word_len25_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {25,
  3},
  4,
  kmap5_Word_len25_anagram3_chords,
  kmap5_Word_len25_anagram3_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len25_anagram4_chords = {ChordData {{16, 4, 19}}, ChordData {{20, 0, 16}}};

c_array_t<uint8_t, 7> const kmap5_Word_len25_anagram4_seqs = {191, 231, 45, 155,
  91, 243, 2};

LookupKmapTypeLenAnagram const kmap5_Word_len25_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {25,
  4},
  2,
  kmap5_Word_len25_anagram4_chords,
  kmap5_Word_len25_anagram4_seqs};

c_array_t<ChordData, 154> const kmap5_Word_len26_anagram0_chords = {ChordData {{0, 4, 210}}, ChordData {{0, 36, 139}}, ChordData {{0, 44, 129}}, ChordData {{0, 72, 16}},
...
c_array_t<uint8_t, 501> const kmap5_Word_len26_anagram0_seqs = {242, 244, 91, 226,
  107, 129, 119, 236,
  233, 35, 31, 23,
  12, 0, 123, 44,
  142, 118, 175, 39,
...
LookupKmapTypeLenAnagram const kmap5_Word_len26_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {26,
  0},
  154,
  kmap5_Word_len26_anagram0_chords,
  kmap5_Word_len26_anagram0_seqs};

c_array_t<ChordData, 23> const kmap5_Word_len26_anagram1_chords = {ChordData {{0, 13, 10}}, ChordData {{0, 64, 16}}, ChordData {{0, 72, 80}}, ChordData {{2, 68, 3}},
...
c_array_t<uint8_t, 75> const kmap5_Word_len26_anagram1_seqs = {69, 125, 44, 242,
  97, 193, 192, 71,
  1, 195, 135, 48,
  120, 62, 175, 62,
  5, 119, 214, 176,
...
LookupKmapTypeLenAnagram const kmap5_Word_len26_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {26,
  1},
  23,
  kmap5_Word_len26_anagram1_chords,
  kmap5_Word_len26_anagram1_seqs};

c_array_t<ChordData, 16> const kmap5_Word_len26_anagram2_chords = {ChordData {{2, 4, 73}}, ChordData {{4, 12, 128}}, ChordData {{16, 32, 18}}, ChordData {{16, 37, 17}},
...
c_array_t<uint8_t, 52> const kmap5_Word_len26_anagram2_seqs = {188, 252, 232, 53,
  250, 130, 143, 204,
  187, 101, 247, 199,
  188, 192, 250, 144,
  193, 173, 10, 205,
...
LookupKmapTypeLenAnagram const kmap5_Word_len26_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {26,
  2},
  16,
  kmap5_Word_len26_anagram2_chords,
  kmap5_Word_len26_anagram2_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len26_anagram3_chords = {ChordData {{36, 0, 18}}, ChordData {{48, 5, 136}}};

c_array_t<uint8_t, 7> const kmap5_Word_len26_anagram3_seqs = {173, 182, 86, 118,
  244, 10, 13};

LookupKmapTypeLenAnagram const kmap5_Word_len26_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {26,
  3},
  2,
  kmap5_Word_len26_anagram3_chords,
  kmap5_Word_len26_anagram3_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len26_anagram4_chords = {ChordData {{48, 8, 80}}};

c_array_t<uint8_t, 4> const kmap5_Word_len26_anagram4_seqs = {82, 99, 244, 2};

LookupKmapTypeLenAnagram const kmap5_Word_len26_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {26,
  4},
  1,
  kmap5_Word_len26_anagram4_chords,
  kmap5_Word_len26_anagram4_seqs};

c_array_t<ChordData, 153> const kmap5_Word_len27_anagram0_chords = {ChordData {{0, 12, 19}}, ChordData {{0, 13, 3}}, ChordData {{2, 12, 192}}, ChordData {{2, 32, 82}},
...
c_array_t<uint8_t, 517> const kmap5_Word_len27_anagram0_seqs = {241, 247, 202, 253,
  187, 199, 34, 63,
  66, 31, 121, 100,
  59, 210, 141, 142,
  176, 142, 70, 145,
...
LookupKmapTypeLenAnagram const kmap5_Word_len27_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {27,
  0},
  153,
  kmap5_Word_len27_anagram0_chords,
  kmap5_Word_len27_anagram0_seqs};

c_array_t<ChordData, 25> const kmap5_Word_len27_anagram1_chords = {ChordData {{0, 13, 146}}, ChordData {{0, 36, 80}}, ChordData {{2, 36, 10}}, ChordData {{16, 4, 90}},
...
c_array_t<uint8_t, 85> const kmap5_Word_len27_anagram1_seqs = {29, 125, 177, 228,
  229, 247, 25, 143,
  108, 244, 5, 95,
  213, 139, 214, 219,
  167, 248, 91, 244,
...
LookupKmapTypeLenAnagram const kmap5_Word_len27_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {27,
  1},
  25,
  kmap5_Word_len27_anagram1_chords,
  kmap5_Word_len27_anagram1_seqs};

c_array_t<ChordData, 7> const kmap5_Word_len27_anagram2_chords = {ChordData {{16, 0, 147}}, ChordData {{16, 13, 16}}, ChordData {{16, 68, 146}}, ChordData {{48, 5, 152}},
  ChordData {{52, 4, 16}}, ChordData {{148, 64, 18}}, ChordData {{164, 68, 16}}};

c_array_t<uint8_t, 24> const kmap5_Word_len27_anagram2_seqs = {252, 149, 228, 93,
  199, 223, 98, 48,
  210, 175, 173, 244,
  11, 221, 215, 245,
  215, 150, 64, 240,
...
LookupKmapTypeLenAnagram const kmap5_Word_len27_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {27,
  2},
  7,
  kmap5_Word_len27_anagram2_chords,
  kmap5_Word_len27_anagram2_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len27_anagram3_chords = {ChordData {{16, 68, 146}}, ChordData {{52, 0, 80}}};

c_array_t<uint8_t, 7> const kmap5_Word_len27_anagram3_seqs = {244, 64, 233, 149,
  218, 188, 61};

LookupKmapTypeLenAnagram const kmap5_Word_len27_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {27,
  3},
  2,
  kmap5_Word_len27_anagram3_chords,
  kmap5_Word_len27_anagram3_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len27_anagram7_chords = {ChordData {{48, 8, 80}}};

c_array_t<uint8_t, 4> const kmap5_Word_len27_anagram7_seqs = {107, 206, 43, 6};

LookupKmapTypeLenAnagram const kmap5_Word_len27_anagram7 = LookupKmapTypeLenAnagram {LengthAndAnagram {27,
  7},
  1,
  kmap5_Word_len27_anagram7_chords,
  kmap5_Word_len27_anagram7_seqs};

c_array_t<ChordData, 134> const kmap5_Word_len28_anagram0_chords = {ChordData {{0, 45, 73}}, ChordData {{0, 68, 210}}, ChordData {{0, 72, 210}}, ChordData {{2, 4, 73}},
...
c_array_t<uint8_t, 469> const kmap5_Word_len28_anagram0_seqs = {199, 94, 139, 242,
  4, 124, 41, 177,
  148, 66, 52, 42,
  247, 122, 183, 175,
  50, 55, 58, 55,
...
LookupKmapTypeLenAnagram const kmap5_Word_len28_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {28,
  0},
  134,
  kmap5_Word_len28_anagram0_chords,
  kmap5_Word_len28_anagram0_seqs};

c_array_t<ChordData, 28> const kmap5_Word_len28_anagram1_chords = {ChordData {{2, 4, 194}}, ChordData {{2, 5, 16}}, ChordData {{2, 64, 66}}, ChordData {{16, 4, 195}},
...
c_array_t<uint8_t, 98> const kmap5_Word_len28_anagram1_seqs = {72, 47, 50, 248,
  93, 247, 179, 188,
  0, 35, 194, 159,
  65, 47, 248, 130,
  31, 28, 71, 100,
...
LookupKmapTypeLenAnagram const kmap5_Word_len28_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {28,
  1},
  28,
  kmap5_Word_len28_anagram1_chords,
  kmap5_Word_len28_anagram1_seqs};

c_array_t<ChordData, 11> const kmap5_Word_len28_anagram2_chords = {ChordData {{0, 4, 26}}, ChordData {{2, 4, 147}}, ChordData {{20, 0, 19}}, ChordData {{20, 4, 16}},
...
c_array_t<uint8_t, 39> const kmap5_Word_len28_anagram2_seqs = {188, 190, 98, 201,
  207, 61, 149, 205,
  139, 110, 215, 214,
  237, 215, 237, 247,
  212, 219, 214, 113,
...
LookupKmapTypeLenAnagram const kmap5_Word_len28_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {28,
  2},
  11,
  kmap5_Word_len28_anagram2_chords,
  kmap5_Word_len28_anagram2_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len28_anagram3_chords = {ChordData {{0, 4, 19}}, ChordData {{48, 0, 147}}, ChordData {{48, 8, 24}}, ChordData {{48, 13, 64}},
  ChordData {{128, 4, 27}}};

c_array_t<uint8_t, 18> const kmap5_Word_len28_anagram3_seqs = {127, 183, 143, 135,
  84, 239, 188, 107,
  206, 90, 205, 115,
  134, 47, 248, 123,
  153, 10};

LookupKmapTypeLenAnagram const kmap5_Word_len28_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {28,
  3},
  5,
  kmap5_Word_len28_anagram3_chords,
  kmap5_Word_len28_anagram3_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len28_anagram4_chords = {ChordData {{16, 36, 17}}};

c_array_t<uint8_t, 4> const kmap5_Word_len28_anagram4_seqs = {204, 127, 204, 11};

LookupKmapTypeLenAnagram const kmap5_Word_len28_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {28,
  4},
  1,
  kmap5_Word_len28_anagram4_chords,
  kmap5_Word_len28_anagram4_seqs};

c_array_t<ChordData, 149> const kmap5_Word_len29_anagram0_chords = {ChordData {{0, 4, 219}}, ChordData {{0, 36, 83}}, ChordData {{0, 40, 19}}, ChordData {{0, 68, 154}},
...
c_array_t<uint8_t, 541> const kmap5_Word_len29_anagram0_seqs = {82, 234, 61, 72,
  112, 255, 144, 45,
  43, 143, 69, 62,
  148, 244, 202, 71,
  16, 24, 226, 239,
...
LookupKmapTypeLenAnagram const kmap5_Word_len29_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {29,
  0},
  149,
  kmap5_Word_len29_anagram0_chords,
  kmap5_Word_len29_anagram0_seqs};

c_array_t<ChordData, 27> const kmap5_Word_len29_anagram1_chords = {ChordData {{2, 36, 19}}, ChordData {{2, 68, 146}}, ChordData {{18, 4, 136}}, ChordData {{18, 4, 208}},
...
c_array_t<uint8_t, 98> const kmap5_Word_len29_anagram1_seqs = {191, 199, 118, 112,
  63, 12, 62, 241,
  166, 31, 125, 126,
  100, 223, 4, 236,
  220, 89, 131, 113,
...
LookupKmapTypeLenAnagram const kmap5_Word_len29_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {29,
  1},
  27,
  kmap5_Word_len29_anagram1_chords,
  kmap5_Word_len29_anagram1_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len29_anagram2_chords = {ChordData {{16, 4, 153}}, ChordData {{16, 4, 155}}, ChordData {{36, 8, 0}}, ChordData {{48, 1, 16}},
  ChordData {{52, 12, 16}}};

c_array_t<uint8_t, 19> const kmap5_Word_len29_anagram2_seqs = {60, 248, 171, 143,
  254, 172, 88, 246,
  181, 96, 193, 117,
  87, 161, 253, 125,
  191, 230, 0};

LookupKmapTypeLenAnagram const kmap5_Word_len29_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {29,
  2},
  5,
  kmap5_Word_len29_anagram2_chords,
  kmap5_Word_len29_anagram2_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len29_anagram3_chords = {ChordData {{18, 0, 131}}, ChordData {{18, 64, 19}}, ChordData {{160, 33, 1}}};

c_array_t<uint8_t, 11> const kmap5_Word_len29_anagram3_seqs = {103, 208, 13, 249,
  128, 185, 243, 118,
  89, 33, 59};

LookupKmapTypeLenAnagram const kmap5_Word_len29_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {29,
  3},
  3,
  kmap5_Word_len29_anagram3_chords,
  kmap5_Word_len29_anagram3_seqs};

c_array_t<ChordData, 117> const kmap5_Word_len30_anagram0_chords = {ChordData {{0, 0, 73}}, ChordData {{0, 4, 211}}, ChordData {{0, 72, 80}}, ChordData {{2, 4, 146}},
...
c_array_t<uint8_t, 439> const kmap5_Word_len30_anagram0_seqs = {188, 240, 199, 43,
  110, 41, 247, 196,
  199, 21, 48, 60,
  110, 73, 131, 221,
  11, 142, 28, 248,
...
LookupKmapTypeLenAnagram const kmap5_Word_len30_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {30,
  0},
  117,
  kmap5_Word_len30_anagram0_chords,
  kmap5_Word_len30_anagram0_seqs};

c_array_t<ChordData, 26> const kmap5_Word_len30_anagram1_chords = {ChordData {{0, 0, 192}}, ChordData {{2, 4, 147}}, ChordData {{16, 4, 27}}, ChordData {{16, 4, 147}},
...
c_array_t<uint8_t, 98> const kmap5_Word_len30_anagram1_seqs = {188, 240, 194, 19,
  210, 239, 92, 105,
  189, 125, 69, 27,
  116, 251, 120, 124,
  209, 68, 101, 247,
...
LookupKmapTypeLenAnagram const kmap5_Word_len30_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {30,
  1},
  26,
  kmap5_Word_len30_anagram1_chords,
  kmap5_Word_len30_anagram1_seqs};

c_array_t<ChordData, 8> const kmap5_Word_len30_anagram2_chords = {ChordData {{34, 12, 136}}, ChordData {{48, 0, 147}}, ChordData {{48, 5, 146}}, ChordData {{50, 13, 9}},
  ChordData {{52, 0, 128}}, ChordData {{164, 64, 18}}, ChordData {{178, 1, 24}}, ChordData {{180, 0, 16}}};

c_array_t<uint8_t, 30> const kmap5_Word_len30_anagram2_seqs = {220, 235, 16, 253,
  25, 116, 117, 13,
  159, 200, 91, 114,
  163, 247, 208, 125,
  237, 123, 50, 38,
...
LookupKmapTypeLenAnagram const kmap5_Word_len30_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {30,
  2},
  8,
  kmap5_Word_len30_anagram2_chords,
  kmap5_Word_len30_anagram2_seqs};

c_array_t<ChordData, 106> const kmap5_Word_len31_anagram0_chords = {ChordData {{0, 64, 72}}, ChordData {{0, 68, 88}}, ChordData {{2, 36, 19}}, ChordData {{2, 69, 130}},
...
c_array_t<uint8_t, 411> const kmap5_Word_len31_anagram0_seqs = {124, 224, 149, 23,
  94, 94, 195, 62,
  178, 223, 185, 178,
  163, 71, 156, 192,
  31, 143, 124, 227,
...
LookupKmapTypeLenAnagram const kmap5_Word_len31_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {31,
  0},
  106,
  kmap5_Word_len31_anagram0_chords,
  kmap5_Word_len31_anagram0_seqs};

c_array_t<ChordData, 22> const kmap5_Word_len31_anagram1_chords = {ChordData {{0, 36, 9}}, ChordData {{0, 68, 8}}, ChordData {{6, 0, 64}}, ChordData {{6, 4, 147}},
...
c_array_t<uint8_t, 86> const kmap5_Word_len31_anagram1_seqs = {188, 254, 177, 87,
  62, 240, 202, 63,
  63, 188, 240, 237,
  202, 54, 248, 212,
  166, 96, 193, 95,
...
LookupKmapTypeLenAnagram const kmap5_Word_len31_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {31,
  1},
  22,
  kmap5_Word_len31_anagram1_chords,
  kmap5_Word_len31_anagram1_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len31_anagram2_chords = {ChordData {{0, 68, 10}}, ChordData {{16, 0, 146}}, ChordData {{32, 0, 146}}, ChordData {{48, 5, 128}},
  ChordData {{54, 8, 192}}};

c_array_t<uint8_t, 20> const kmap5_Word_len31_anagram2_seqs = {60, 190, 126, 120,
  30, 220, 187, 37,
  85, 80, 221, 146,
  42, 132, 15, 45,
  181, 167, 137, 6};

LookupKmapTypeLenAnagram const kmap5_Word_len31_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {31,
  2},
  5,
  kmap5_Word_len31_anagram2_chords,
  kmap5_Word_len31_anagram2_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len31_anagram3_chords = {ChordData {{48, 8, 18}}};

c_array_t<uint8_t, 4> const kmap5_Word_len31_anagram3_seqs = {209, 139, 117, 75};

LookupKmapTypeLenAnagram const kmap5_Word_len31_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {31,
  3},
  1,
  kmap5_Word_len31_anagram3_chords,
  kmap5_Word_len31_anagram3_seqs};

c_array_t<ChordData, 111> const kmap5_Word_len32_anagram0_chords = {ChordData {{0, 0, 26}}, ChordData {{0, 5, 91}}, ChordData {{0, 33, 72}}, ChordData {{0, 45, 19}},
...
c_array_t<uint8_t, 444> const kmap5_Word_len32_anagram0_seqs = {188, 242, 37, 143,
  221, 235, 189, 148,
  93, 97, 40, 160,
  124, 241, 143, 149,
  188, 240, 145, 15,
...
LookupKmapTypeLenAnagram const kmap5_Word_len32_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {32,
  0},
  111,
  kmap5_Word_len32_anagram0_chords,
  kmap5_Word_len32_anagram0_seqs};

c_array_t<ChordData, 16> const kmap5_Word_len32_anagram1_chords = {ChordData {{16, 8, 19}}, ChordData {{16, 8, 83}}, ChordData {{18, 12, 9}}, ChordData {{18, 68, 11}},
...
c_array_t<uint8_t, 64> const kmap5_Word_len32_anagram1_seqs = {232, 232, 243, 150,
  177, 148, 243, 150,
  163, 55, 241, 207,
  143, 56, 193, 122,
  109, 31, 111, 208,
...
LookupKmapTypeLenAnagram const kmap5_Word_len32_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {32,
  1},
  16,
  kmap5_Word_len32_anagram1_chords,
  kmap5_Word_len32_anagram1_seqs};

c_array_t<ChordData, 6> const kmap5_Word_len32_anagram2_chords = {ChordData {{16, 12, 81}}, ChordData {{36, 0, 2}}, ChordData {{48, 69, 24}}, ChordData {{128, 4, 27}},
  ChordData {{130, 4, 11}}, ChordData {{164, 4, 146}}};

c_array_t<uint8_t, 24> const kmap5_Word_len32_anagram2_seqs = {241, 239, 214, 34,
  60, 242, 141, 175,
  214, 240, 10, 189,
  152, 122, 251, 120,
  56, 247, 55, 169,
...
LookupKmapTypeLenAnagram const kmap5_Word_len32_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {32,
  2},
  6,
  kmap5_Word_len32_anagram2_chords,
  kmap5_Word_len32_anagram2_seqs};

c_array_t<ChordData, 87> const kmap5_Word_len33_anagram0_chords = {ChordData {{0, 69, 0}}, ChordData {{0, 69, 18}}, ChordData {{2, 12, 9}}, ChordData {{2, 12, 154}},
...
c_array_t<uint8_t, 359> const kmap5_Word_len33_anagram0_seqs = {124, 199, 7, 254,
  187, 223, 15, 95,
  198, 31, 189, 31,
  197, 157, 56, 250,
  196, 7, 126, 248,
...
LookupKmapTypeLenAnagram const kmap5_Word_len33_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {33,
  0},
  87,
  kmap5_Word_len33_anagram0_chords,
  kmap5_Word_len33_anagram0_seqs};

c_array_t<ChordData, 15> const kmap5_Word_len33_anagram1_chords = {ChordData {{4, 40, 0}}, ChordData {{18, 1, 9}}, ChordData {{18, 44, 10}}, ChordData {{18, 44, 130}},
...
c_array_t<uint8_t, 62> const kmap5_Word_len33_anagram1_seqs = {124, 228, 27, 207,
  70, 187, 209, 57,
  71, 35, 123, 29,
  68, 230, 56, 248,
  212, 214, 56, 109,
...
LookupKmapTypeLenAnagram const kmap5_Word_len33_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {33,
  1},
  15,
  kmap5_Word_len33_anagram1_chords,
  kmap5_Word_len33_anagram1_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len33_anagram2_chords = {ChordData {{36, 9, 0}}, ChordData {{144, 8, 26}}};

c_array_t<uint8_t, 9> const kmap5_Word_len33_anagram2_seqs = {124, 228, 27, 15,
  209, 235, 152, 90,
  2};

LookupKmapTypeLenAnagram const kmap5_Word_len33_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {33,
  2},
  2,
  kmap5_Word_len33_anagram2_chords,
  kmap5_Word_len33_anagram2_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len33_anagram3_chords = {ChordData {{20, 4, 25}}};

c_array_t<uint8_t, 5> const kmap5_Word_len33_anagram3_seqs = {223, 218, 175, 245,
  0};

LookupKmapTypeLenAnagram const kmap5_Word_len33_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {33,
  3},
  1,
  kmap5_Word_len33_anagram3_chords,
  kmap5_Word_len33_anagram3_seqs};

c_array_t<ChordData, 74> const kmap5_Word_len34_anagram0_chords = {ChordData {{0, 68, 89}}, ChordData {{2, 4, 218}}, ChordData {{6, 36, 74}}, ChordData {{16, 1, 26}},
...
c_array_t<uint8_t, 315> const kmap5_Word_len34_anagram0_seqs = {114, 175, 225, 55,
  188, 62, 149, 50,
  194, 70, 218, 235,
  224, 186, 243, 90,
  209, 79, 231, 213,
...
LookupKmapTypeLenAnagram const kmap5_Word_len34_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {34,
  0},
  74,
  kmap5_Word_len34_anagram0_chords,
  kmap5_Word_len34_anagram0_seqs};

c_array_t<ChordData, 12> const kmap5_Word_len34_anagram1_chords = {ChordData {{0, 4, 211}}, ChordData {{2, 5, 19}}, ChordData {{18, 4, 25}}, ChordData {{20, 0, 89}},
...
c_array_t<uint8_t, 51> const kmap5_Word_len34_anagram1_seqs = {248, 247, 84, 202,
  253, 222, 116, 143,
  103, 61, 239, 253,
  232, 186, 173, 197,
  122, 60, 251, 229,
...
LookupKmapTypeLenAnagram const kmap5_Word_len34_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {34,
  1},
  12,
  kmap5_Word_len34_anagram1_chords,
  kmap5_Word_len34_anagram1_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len34_anagram2_chords = {ChordData {{38, 1, 0}}, ChordData {{48, 5, 136}}};

c_array_t<uint8_t, 9> const kmap5_Word_len34_anagram2_seqs = {124, 199, 247, 252,
  208, 43, 172, 15,
  13};

LookupKmapTypeLenAnagram const kmap5_Word_len34_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {34,
  2},
  2,
  kmap5_Word_len34_anagram2_chords,
  kmap5_Word_len34_anagram2_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len34_anagram4_chords = {ChordData {{20, 4, 25}}};

c_array_t<uint8_t, 5> const kmap5_Word_len34_anagram4_seqs = {205, 234, 219, 63,
  3};

LookupKmapTypeLenAnagram const kmap5_Word_len34_anagram4 = LookupKmapTypeLenAnagram {LengthAndAnagram {34,
  4},
  1,
  kmap5_Word_len34_anagram4_chords,
  kmap5_Word_len34_anagram4_seqs};

c_array_t<ChordData, 67> const kmap5_Word_len35_anagram0_chords = {ChordData {{0, 68, 2}}, ChordData {{2, 13, 144}}, ChordData {{6, 4, 19}}, ChordData {{16, 4, 217}},
...
c_array_t<uint8_t, 294> const kmap5_Word_len35_anagram0_seqs = {129, 127, 30, 121,
  236, 62, 14, 205,
  47, 126, 123, 156,
  43, 111, 95, 133,
  254, 28, 140, 235,
...
LookupKmapTypeLenAnagram const kmap5_Word_len35_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {35,
  0},
  67,
  kmap5_Word_len35_anagram0_chords,
  kmap5_Word_len35_anagram0_seqs};

c_array_t<ChordData, 10> const kmap5_Word_len35_anagram1_chords = {ChordData {{2, 12, 147}}, ChordData {{18, 4, 89}}, ChordData {{36, 4, 83}}, ChordData {{48, 5, 145}},
  ChordData {{48, 37, 138}}, ChordData {{52, 72, 0}}, ChordData {{134, 0, 72}}, ChordData {{146, 4, 25}},
  ChordData {{176, 8, 9}}, ChordData {{180, 64, 64}}};

c_array_t<uint8_t, 44> const kmap5_Word_len35_anagram1_seqs = {113, 104, 238, 183,
  92, 203, 200, 189,
  158, 212, 254, 246,
  241, 224, 254, 185,
  171, 100, 16, 178,
...
LookupKmapTypeLenAnagram const kmap5_Word_len35_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {35,
  1},
  10,
  kmap5_Word_len35_anagram1_chords,
  kmap5_Word_len35_anagram1_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len35_anagram2_chords = {ChordData {{146, 0, 11}}};

c_array_t<uint8_t, 5> const kmap5_Word_len35_anagram2_seqs = {152, 122, 163, 214,
  3};

LookupKmapTypeLenAnagram const kmap5_Word_len35_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {35,
  2},
  1,
  kmap5_Word_len35_anagram2_chords,
  kmap5_Word_len35_anagram2_seqs};

c_array_t<ChordData, 54> const kmap5_Word_len36_anagram0_chords = {ChordData {{0, 68, 27}}, ChordData {{0, 77, 18}}, ChordData {{2, 5, 210}}, ChordData {{2, 100, 18}},
...
c_array_t<uint8_t, 243> const kmap5_Word_len36_anagram0_seqs = {192, 239, 190, 94,
  249, 64, 17, 248,
  13, 72, 47, 50,
  93, 201, 239, 32,
  251, 13, 242, 26,
...
LookupKmapTypeLenAnagram const kmap5_Word_len36_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {36,
  0},
  54,
  kmap5_Word_len36_anagram0_chords,
  kmap5_Word_len36_anagram0_seqs};

c_array_t<ChordData, 9> const kmap5_Word_len36_anagram1_chords = {ChordData {{2, 4, 67}}, ChordData {{2, 5, 147}}, ChordData {{16, 0, 139}}, ChordData {{16, 4, 83}},
  ChordData {{48, 5, 25}}, ChordData {{50, 12, 9}}, ChordData {{130, 0, 202}}, ChordData {{148, 4, 19}},
  ChordData {{148, 8, 11}}};

c_array_t<uint8_t, 41> const kmap5_Word_len36_anagram1_seqs = {114, 127, 35, 55,
  216, 61, 14, 205,
  149, 6, 161, 137,
  172, 39, 198, 245,
  253, 150, 176, 254,
...
LookupKmapTypeLenAnagram const kmap5_Word_len36_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {36,
  1},
  9,
  kmap5_Word_len36_anagram1_chords,
  kmap5_Word_len36_anagram1_seqs};

c_array_t<ChordData, 66> const kmap5_Word_len37_anagram0_chords = {ChordData {{0, 69, 128}}, ChordData {{2, 8, 65}}, ChordData {{2, 8, 83}}, ChordData {{2, 36, 91}},
...
c_array_t<uint8_t, 306> const kmap5_Word_len37_anagram0_seqs = {124, 199, 63, 95,
  72, 110, 98, 165,
  63, 227, 206, 13,
  142, 68, 100, 59,
  114, 243, 202, 3,
...
LookupKmapTypeLenAnagram const kmap5_Word_len37_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {37,
  0},
  66,
  kmap5_Word_len37_anagram0_chords,
  kmap5_Word_len37_anagram0_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len37_anagram1_chords = {ChordData {{18, 12, 138}}, ChordData {{22, 0, 154}}, ChordData {{22, 4, 138}}, ChordData {{52, 4, 208}},
  ChordData {{180, 64, 18}}};

c_array_t<uint8_t, 24> const kmap5_Word_len37_anagram1_seqs = {124, 52, 104, 240,
  181, 237, 40, 78,
  35, 127, 107, 52,
  175, 104, 113, 251,
  253, 158, 220, 54,
...
LookupKmapTypeLenAnagram const kmap5_Word_len37_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {37,
  1},
  5,
  kmap5_Word_len37_anagram1_chords,
  kmap5_Word_len37_anagram1_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len37_anagram2_chords = {ChordData {{18, 68, 11}}};

c_array_t<uint8_t, 5> const kmap5_Word_len37_anagram2_seqs = {248, 26, 38, 252,
  25};

LookupKmapTypeLenAnagram const kmap5_Word_len37_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {37,
  2},
  1,
  kmap5_Word_len37_anagram2_chords,
  kmap5_Word_len37_anagram2_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len37_anagram3_chords = {ChordData {{48, 5, 17}}};

c_array_t<uint8_t, 5> const kmap5_Word_len37_anagram3_seqs = {15, 225, 26, 254,
  25};

LookupKmapTypeLenAnagram const kmap5_Word_len37_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {37,
  3},
  1,
  kmap5_Word_len37_anagram3_chords,
  kmap5_Word_len37_anagram3_seqs};

c_array_t<ChordData, 38> const kmap5_Word_len38_anagram0_chords = {ChordData {{2, 5, 75}}, ChordData {{2, 44, 75}}, ChordData {{2, 44, 83}}, ChordData {{6, 4, 154}},
...
c_array_t<uint8_t, 181> const kmap5_Word_len38_anagram0_seqs = {221, 235, 189, 220,
  96, 124, 100, 163,
  35, 135, 108, 71,
  46, 190, 180, 29,
  197, 105, 79, 238,
...
LookupKmapTypeLenAnagram const kmap5_Word_len38_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {38,
  0},
  38,
  kmap5_Word_len38_anagram0_chords,
  kmap5_Word_len38_anagram0_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len38_anagram1_chords = {ChordData {{18, 32, 91}}, ChordData {{22, 0, 89}}, ChordData {{48, 5, 26}}, ChordData {{54, 0, 147}},
  ChordData {{178, 8, 137}}};

c_array_t<uint8_t, 24> const kmap5_Word_len38_anagram1_seqs = {82, 234, 49, 203,
  136, 245, 188, 109,
  71, 220, 237, 195,
  125, 69, 163, 201,
  253, 206, 149, 230,
...
LookupKmapTypeLenAnagram const kmap5_Word_len38_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {38,
  1},
  5,
  kmap5_Word_len38_anagram1_chords,
  kmap5_Word_len38_anagram1_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len38_anagram2_chords = {ChordData {{50, 8, 9}}};

c_array_t<uint8_t, 5> const kmap5_Word_len38_anagram2_seqs = {163, 87, 231, 134,
  51};

LookupKmapTypeLenAnagram const kmap5_Word_len38_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {38,
  2},
  1,
  kmap5_Word_len38_anagram2_chords,
  kmap5_Word_len38_anagram2_seqs};

c_array_t<ChordData, 35> const kmap5_Word_len39_anagram0_chords = {ChordData {{2, 12, 210}}, ChordData {{2, 65, 0}}, ChordData {{4, 44, 83}}, ChordData {{18, 5, 129}},
...
c_array_t<uint8_t, 171> const kmap5_Word_len39_anagram0_seqs = {50, 113, 232, 151,
  202, 48, 93, 231,
  181, 158, 148, 177,
  253, 177, 242, 187,
  110, 104, 254, 204,
...
LookupKmapTypeLenAnagram const kmap5_Word_len39_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {39,
  0},
  35,
  kmap5_Word_len39_anagram0_chords,
  kmap5_Word_len39_anagram0_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len39_anagram1_chords = {ChordData {{16, 68, 83}}, ChordData {{50, 1, 25}}, ChordData {{146, 0, 75}}};

c_array_t<uint8_t, 15> const kmap5_Word_len39_anagram1_seqs = {165, 229, 188, 225,
  203, 174, 174, 206,
  213, 53, 166, 202,
  200, 89, 15};

LookupKmapTypeLenAnagram const kmap5_Word_len39_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {39,
  1},
  3,
  kmap5_Word_len39_anagram1_chords,
  kmap5_Word_len39_anagram1_seqs};

c_array_t<ChordData, 29> const kmap5_Word_len40_anagram0_chords = {ChordData {{0, 4, 72}}, ChordData {{6, 12, 146}}, ChordData {{16, 0, 80}}, ChordData {{20, 68, 19}},
...
c_array_t<uint8_t, 145> const kmap5_Word_len40_anagram0_seqs = {188, 242, 207, 11,
  255, 109, 39, 254,
  14, 149, 107, 73,
  170, 55, 169, 193,
  109, 141, 127, 14,
...
LookupKmapTypeLenAnagram const kmap5_Word_len40_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {40,
  0},
  29,
  kmap5_Word_len40_anagram0_chords,
  kmap5_Word_len40_anagram0_seqs};

c_array_t<ChordData, 2> const kmap5_Word_len40_anagram1_chords = {ChordData {{54, 8, 192}}, ChordData {{132, 12, 26}}};

c_array_t<uint8_t, 10> const kmap5_Word_len40_anagram1_seqs = {19, 91, 37, 25,
  206, 143, 152, 177,
  189, 150};

LookupKmapTypeLenAnagram const kmap5_Word_len40_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {40,
  1},
  2,
  kmap5_Word_len40_anagram1_chords,
  kmap5_Word_len40_anagram1_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len40_anagram2_chords = {ChordData {{22, 4, 19}}};

c_array_t<uint8_t, 5> const kmap5_Word_len40_anagram2_seqs = {223, 218, 26, 231,
  207};

LookupKmapTypeLenAnagram const kmap5_Word_len40_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {40,
  2},
  1,
  kmap5_Word_len40_anagram2_chords,
  kmap5_Word_len40_anagram2_seqs};

c_array_t<ChordData, 37> const kmap5_Word_len41_anagram0_chords = {ChordData {{6, 76, 146}}, ChordData {{16, 44, 11}}, ChordData {{18, 1, 75}}, ChordData {{18, 76, 210}},
...
c_array_t<uint8_t, 190> const kmap5_Word_len41_anagram0_seqs = {173, 220, 143, 19,
  158, 254, 238, 145,
  69, 235, 9, 142,
  245, 166, 27, 12,
  35, 72, 63, 209,
...
LookupKmapTypeLenAnagram const kmap5_Word_len41_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {41,
  0},
  37,
  kmap5_Word_len41_anagram0_chords,
  kmap5_Word_len41_anagram0_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len41_anagram1_chords = {ChordData {{34, 13, 24}}, ChordData {{130, 68, 27}}, ChordData {{178, 8, 11}}};

c_array_t<uint8_t, 16> const kmap5_Word_len41_anagram1_seqs = {60, 55, 11, 71,
  231, 49, 245, 246,
  195, 224, 97, 42,
  103, 189, 73, 5};

LookupKmapTypeLenAnagram const kmap5_Word_len41_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {41,
  1},
  3,
  kmap5_Word_len41_anagram1_chords,
  kmap5_Word_len41_anagram1_seqs};

c_array_t<ChordData, 32> const kmap5_Word_len42_anagram0_chords = {ChordData {{2, 5, 147}}, ChordData {{2, 65, 2}}, ChordData {{2, 65, 128}}, ChordData {{4, 65, 130}},
...
c_array_t<uint8_t, 168> const kmap5_Word_len42_anagram0_seqs = {191, 55, 221, 224,
  60, 133, 233, 58,
  175, 21, 29, 166,
  235, 6, 43, 93,
  32, 190, 241, 29,
...
LookupKmapTypeLenAnagram const kmap5_Word_len42_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {42,
  0},
  32,
  kmap5_Word_len42_anagram0_chords,
  kmap5_Word_len42_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len42_anagram1_chords = {ChordData {{134, 0, 25}}};

c_array_t<uint8_t, 6> const kmap5_Word_len42_anagram1_seqs = {109, 179, 229, 222,
  164, 2};

LookupKmapTypeLenAnagram const kmap5_Word_len42_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {42,
  1},
  1,
  kmap5_Word_len42_anagram1_chords,
  kmap5_Word_len42_anagram1_seqs};

c_array_t<ChordData, 25> const kmap5_Word_len43_anagram0_chords = {ChordData {{4, 72, 64}}, ChordData {{4, 73, 2}}, ChordData {{18, 12, 11}}, ChordData {{32, 8, 144}},
...
c_array_t<uint8_t, 135> const kmap5_Word_len43_anagram0_seqs = {124, 227, 3, 31,
  121, 9, 145, 111,
  124, 199, 99, 252,
  209, 179, 190, 162,
  121, 142, 95, 62,
...
LookupKmapTypeLenAnagram const kmap5_Word_len43_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {43,
  0},
  25,
  kmap5_Word_len43_anagram0_chords,
  kmap5_Word_len43_anagram0_seqs};

c_array_t<ChordData, 18> const kmap5_Word_len44_anagram0_chords = {ChordData {{0, 44, 9}}, ChordData {{2, 100, 83}}, ChordData {{18, 5, 19}}, ChordData {{34, 8, 146}},
...
c_array_t<uint8_t, 99> const kmap5_Word_len44_anagram0_seqs = {124, 124, 101, 127,
  247, 26, 74, 249,
  61, 182, 243, 232,
  189, 233, 6, 255,
  140, 117, 119, 176,
...
LookupKmapTypeLenAnagram const kmap5_Word_len44_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {44,
  0},
  18,
  kmap5_Word_len44_anagram0_chords,
  kmap5_Word_len44_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len44_anagram1_chords = {ChordData {{2, 100, 83}}};

c_array_t<uint8_t, 6> const kmap5_Word_len44_anagram1_seqs = {161, 148, 223, 99,
  59, 8};

LookupKmapTypeLenAnagram const kmap5_Word_len44_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {44,
  1},
  1,
  kmap5_Word_len44_anagram1_chords,
  kmap5_Word_len44_anagram1_seqs};

c_array_t<ChordData, 15> const kmap5_Word_len45_anagram0_chords = {ChordData {{0, 4, 145}}, ChordData {{18, 108, 90}}, ChordData {{22, 4, 19}}, ChordData {{34, 76, 136}},
...
c_array_t<uint8_t, 85> const kmap5_Word_len45_anagram0_seqs = {183, 15, 110, 188,
  220, 50, 122, 145,
  189, 134, 17, 183,
  223, 27, 156, 246,
  231, 209, 48, 220,
...
LookupKmapTypeLenAnagram const kmap5_Word_len45_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {45,
  0},
  15,
  kmap5_Word_len45_anagram0_chords,
  kmap5_Word_len45_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len45_anagram3_chords = {ChordData {{38, 4, 147}}};

c_array_t<uint8_t, 6> const kmap5_Word_len45_anagram3_seqs = {248, 237, 251, 161,
  185, 18};

LookupKmapTypeLenAnagram const kmap5_Word_len45_anagram3 = LookupKmapTypeLenAnagram {LengthAndAnagram {45,
  3},
  1,
  kmap5_Word_len45_anagram3_chords,
  kmap5_Word_len45_anagram3_seqs};

c_array_t<ChordData, 16> const kmap5_Word_len46_anagram0_chords = {ChordData {{2, 8, 73}}, ChordData {{6, 4, 27}}, ChordData {{6, 36, 83}}, ChordData {{38, 68, 82}},
...
c_array_t<uint8_t, 92> const kmap5_Word_len46_anagram0_seqs = {114, 19, 43, 253,
  77, 106, 251, 189,
  193, 105, 175, 215,
  164, 68, 54, 127,
  91, 74, 237, 101,
...
LookupKmapTypeLenAnagram const kmap5_Word_len46_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {46,
  0},
  16,
  kmap5_Word_len46_anagram0_chords,
  kmap5_Word_len46_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len46_anagram1_chords = {ChordData {{32, 8, 18}}};

c_array_t<uint8_t, 6> const kmap5_Word_len46_anagram1_seqs = {124, 201, 71, 62,
  242, 28};

LookupKmapTypeLenAnagram const kmap5_Word_len46_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {46,
  1},
  1,
  kmap5_Word_len46_anagram1_chords,
  kmap5_Word_len46_anagram1_seqs};

c_array_t<ChordData, 13> const kmap5_Word_len47_anagram0_chords = {ChordData {{22, 12, 154}}, ChordData {{34, 5, 75}}, ChordData {{38, 4, 201}}, ChordData {{50, 12, 90}},
...
c_array_t<uint8_t, 77> const kmap5_Word_len47_anagram0_seqs = {109, 77, 19, 71,
  127, 75, 25, 168,
  211, 13, 190, 158,
  212, 94, 238, 245,
  230, 233, 85, 135,
...
LookupKmapTypeLenAnagram const kmap5_Word_len47_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {47,
  0},
  13,
  kmap5_Word_len47_anagram0_chords,
  kmap5_Word_len47_anagram0_seqs};

c_array_t<ChordData, 4> const kmap5_Word_len48_anagram0_chords = {ChordData {{48, 13, 27}}, ChordData {{130, 5, 154}}, ChordData {{164, 8, 16}}, ChordData {{182, 72, 26}}};

c_array_t<uint8_t, 24> const kmap5_Word_len48_anagram0_seqs = {241, 181, 118, 143,
  87, 215, 60, 62,
  77, 151, 171, 243,
  124, 219, 228, 38,
  88, 209, 124, 219,
...
LookupKmapTypeLenAnagram const kmap5_Word_len48_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {48,
  0},
  4,
  kmap5_Word_len48_anagram0_chords,
  kmap5_Word_len48_anagram0_seqs};

c_array_t<ChordData, 14> const kmap5_Word_len49_anagram0_chords = {ChordData {{0, 13, 2}}, ChordData {{4, 4, 82}}, ChordData {{18, 76, 91}}, ChordData {{50, 12, 91}},
...
c_array_t<uint8_t, 86> const kmap5_Word_len49_anagram0_seqs = {143, 69, 77, 128,
  28, 160, 249, 229,
  145, 47, 76, 188,
  132, 17, 220, 137,
  163, 127, 198, 89,
...
LookupKmapTypeLenAnagram const kmap5_Word_len49_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {49,
  0},
  14,
  kmap5_Word_len49_anagram0_chords,
  kmap5_Word_len49_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len49_anagram1_chords = {ChordData {{0, 0, 146}}};

c_array_t<uint8_t, 7> const kmap5_Word_len49_anagram1_seqs = {109, 45, 184, 211,
  110, 82, 1};

LookupKmapTypeLenAnagram const kmap5_Word_len49_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {49,
  1},
  1,
  kmap5_Word_len49_anagram1_chords,
  kmap5_Word_len49_anagram1_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len50_anagram0_chords = {ChordData {{2, 4, 66}}, ChordData {{4, 4, 66}}, ChordData {{32, 68, 130}}, ChordData {{162, 68, 203}},
  ChordData {{178, 12, 201}}};

c_array_t<uint8_t, 32> const kmap5_Word_len50_anagram0_seqs = {252, 243, 194, 35,
  63, 252, 240, 141,
  71, 190, 48, 241,
  242, 88, 168, 142,
  204, 77, 234, 99,
...
LookupKmapTypeLenAnagram const kmap5_Word_len50_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {50,
  0},
  5,
  kmap5_Word_len50_anagram0_chords,
  kmap5_Word_len50_anagram0_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len51_anagram0_chords = {ChordData {{6, 8, 1}}, ChordData {{38, 8, 211}}, ChordData {{164, 0, 17}}};

c_array_t<uint8_t, 20> const kmap5_Word_len51_anagram0_seqs = {19, 91, 37, 25,
  110, 174, 156, 216,
  42, 201, 112, 115,
  101, 219, 236, 191,
  31, 154, 43, 1};

LookupKmapTypeLenAnagram const kmap5_Word_len51_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {51,
  0},
  3,
  kmap5_Word_len51_anagram0_chords,
  kmap5_Word_len51_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len51_anagram1_chords = {ChordData {{128, 0, 10}}};

c_array_t<uint8_t, 7> const kmap5_Word_len51_anagram1_seqs = {152, 170, 198, 27,
  110, 174, 4};

LookupKmapTypeLenAnagram const kmap5_Word_len51_anagram1 = LookupKmapTypeLenAnagram {LengthAndAnagram {51,
  1},
  1,
  kmap5_Word_len51_anagram1_chords,
  kmap5_Word_len51_anagram1_seqs};

c_array_t<ChordData, 5> const kmap5_Word_len52_anagram0_chords = {ChordData {{54, 64, 209}}, ChordData {{130, 64, 81}}, ChordData {{150, 32, 83}}, ChordData {{166, 64, 89}},
  ChordData {{178, 12, 202}}};

c_array_t<uint8_t, 33> const kmap5_Word_len52_anagram0_seqs = {109, 189, 46, 84,
  71, 230, 28, 70,
  110, 167, 175, 55,
  169, 60, 178, 29,
  185, 108, 204, 27,
...
LookupKmapTypeLenAnagram const kmap5_Word_len52_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {52,
  0},
  5,
  kmap5_Word_len52_anagram0_chords,
  kmap5_Word_len52_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len52_anagram2_chords = {ChordData {{38, 4, 147}}};

c_array_t<uint8_t, 7> const kmap5_Word_len52_anagram2_seqs = {237, 247, 6, 43,
  253, 82, 9};

LookupKmapTypeLenAnagram const kmap5_Word_len52_anagram2 = LookupKmapTypeLenAnagram {LengthAndAnagram {52,
  2},
  1,
  kmap5_Word_len52_anagram2_chords,
  kmap5_Word_len52_anagram2_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len53_anagram0_chords = {ChordData {{54, 72, 144}}};

c_array_t<uint8_t, 7> const kmap5_Word_len53_anagram0_seqs = {46, 84, 135, 166,
  223, 169, 17};

LookupKmapTypeLenAnagram const kmap5_Word_len53_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {53,
  0},
  1,
  kmap5_Word_len53_anagram0_chords,
  kmap5_Word_len53_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len55_anagram0_chords = {ChordData {{2, 13, 0}}};

c_array_t<uint8_t, 7> const kmap5_Word_len55_anagram0_seqs = {252, 243, 29, 255,
  252, 240, 69};

LookupKmapTypeLenAnagram const kmap5_Word_len55_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {55,
  0},
  1,
  kmap5_Word_len55_anagram0_chords,
  kmap5_Word_len55_anagram0_seqs};

c_array_t<ChordData, 3> const kmap5_Word_len57_anagram0_chords = {ChordData {{22, 76, 219}}, ChordData {{32, 40, 66}}, ChordData {{34, 5, 219}}};

c_array_t<uint8_t, 22> const kmap5_Word_len57_anagram0_seqs = {188, 0, 115, 5,
  189, 244, 26, 120,
  142, 199, 194, 195,
  115, 188, 200, 64,
  157, 110, 240, 245,
...
LookupKmapTypeLenAnagram const kmap5_Word_len57_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {57,
  0},
  3,
  kmap5_Word_len57_anagram0_chords,
  kmap5_Word_len57_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len58_anagram0_chords = {ChordData {{54, 12, 218}}};

c_array_t<uint8_t, 8> const kmap5_Word_len58_anagram0_seqs = {124, 179, 170, 148,
  196, 189, 206, 3};

LookupKmapTypeLenAnagram const kmap5_Word_len58_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {58,
  0},
  1,
  kmap5_Word_len58_anagram0_chords,
  kmap5_Word_len58_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len60_anagram0_chords = {ChordData {{182, 0, 219}}};

c_array_t<uint8_t, 8> const kmap5_Word_len60_anagram0_seqs = {107, 105, 169, 50,
  253, 208, 92, 9};

LookupKmapTypeLenAnagram const kmap5_Word_len60_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {60,
  0},
  1,
  kmap5_Word_len60_anagram0_chords,
  kmap5_Word_len60_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len71_anagram0_chords = {ChordData {{164, 36, 9}}};

c_array_t<uint8_t, 9> const kmap5_Word_len71_anagram0_seqs = {124, 207, 43, 159,
  5, 164, 48, 22,
  70};

LookupKmapTypeLenAnagram const kmap5_Word_len71_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {71,
  0},
  1,
  kmap5_Word_len71_anagram0_chords,
  kmap5_Word_len71_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len79_anagram0_chords = {ChordData {{34, 65, 82}}};

c_array_t<uint8_t, 10> const kmap5_Word_len79_anagram0_seqs = {60, 192, 151, 188,
  240, 195, 3, 124,
  201, 67};

LookupKmapTypeLenAnagram const kmap5_Word_len79_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {79,
  0},
  1,
  kmap5_Word_len79_anagram0_chords,
  kmap5_Word_len79_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len102_anagram0_chords = {ChordData {{16, 1, 144}}};

c_array_t<uint8_t, 13> const kmap5_Word_len102_anagram0_seqs = {235, 142, 140, 55,
  169, 5, 152, 216,
  42, 201, 112, 115,
  37};

LookupKmapTypeLenAnagram const kmap5_Word_len102_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {102,
  0},
  1,
  kmap5_Word_len102_anagram0_chords,
  kmap5_Word_len102_anagram0_seqs};

c_array_t<ChordData, 1> const kmap5_Word_len105_anagram0_chords = {ChordData {{2, 5, 0}}};

c_array_t<uint8_t, 14> const kmap5_Word_len105_anagram0_seqs = {47, 5, 232, 126,
  11, 240, 82, 0,
  126, 10, 80, 212,
  4, 0};

LookupKmapTypeLenAnagram const kmap5_Word_len105_anagram0 = LookupKmapTypeLenAnagram {LengthAndAnagram {105,
  0},
  1,
  kmap5_Word_len105_anagram0_chords,
  kmap5_Word_len105_anagram0_seqs};

c_array_t<LookupKmapTypeLenAnagram const*, 174> const kmap5_Word_lookups_array = {&kmap5_Word_len4_anagram1, &kmap5_Word_len5_anagram1, &kmap5_Word_len7_anagram0, &kmap5_Word_len7_anagram1,
...
LookupKmapType const kmap5_Word_lookups = LookupKmapType {174,
  kmap5_Word_lookups_array};

c_array_t<LookupKmapType const*, 4> const kmap5_lookups_array = {&kmap5_Plain_lookups, &kmap5_Macro_lookups, &kmap5_Command_lookups, &kmap5_Word_lookups};

KmapStruct const kmap5_lookups = KmapStruct {kmap5_lookups_array};

c_array_t<KmapStruct const*, 3> const default_mode_kmaps_array = {&kmap4_lookups, &kmap5_lookups, &kmap0_lookups};
...
c_array_t<KmapStruct const*, 1> const gaming_mode_kmaps_array = {&kmap1_lookups};

c_array_t<ChordData, 10> const gaming_mode_mod_chord = {ChordData {{0, 0, 0}}, ChordData {{0, 0, 0}}, ChordData {{0, 0, 0}}, ChordData {{0, 0, 0}},
...
ModeStruct const gaming_mode_struct = ModeStruct {true,
  1,
  gaming_mode_kmaps_array,
  gaming_mode_mod_chord,
  gaming_mode_anagram_mask};

c_array_t<KmapStruct const*, 1> const left_hand_mode_kmaps_array = {&kmap2_lookups};

c_array_t<ChordData, 10> const left_hand_mode_mod_chord = {ChordData {{0, 0, 0}}, ChordData {{0, 0, 0}}, ChordData {{0, 0, 0}}, ChordData {{0, 0, 0}},
...
c_array_t<KmapStruct const*, 4> const windows_mode_kmaps_array = {&kmap3_lookups, &kmap4_lookups, &kmap5_lookups, &kmap0_lookups};
